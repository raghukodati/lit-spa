 ...
 * Configure enterprise security policies and settings
 */
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
          ...
          <div class="d-flex gap-2">
            ...
            <button @click=${this._handleSave} class="btn btn-primary" ?disabled=${this.saving}>
              ${this.saving ? html`<span class="spinner-border spinner-border-sm me-2"></span>` : html`<i class="bi bi-save me-1"></i>`}
              Save Settings
            </button>
          </div>
        </div>
        ...
        ` : html`
          ...
          <div class="d-grid gap-2 mb-4">
            <button @click=${this._handleSave} class="btn btn-primary btn-lg" ?disabled=${this.saving}>
              ${this.saving ? html`<span class="spinner-border spinner-border-sm me-2"></span>Saving...` : html`<i class="bi bi-save me-2"></i>Save All Security Settings`}
            </button>
          </div>
        `}
      </div>
