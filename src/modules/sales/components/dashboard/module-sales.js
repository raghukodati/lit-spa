...
import {hasPermission} from '../../../../services/dataService.js';

class SalesModulePage extends LitElement {
  ...
  render() {
    return html`
      <div>
        ...
        <!-- Top Customers -->
        ${hasPermission('customers', 'read') ? html`
...
customElements.define('module-sales', SalesModulePage);
