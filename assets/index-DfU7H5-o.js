const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/dataService-CD0XMSGL.js","assets/company.service-D2dl1Zj8.js","assets/company.model-CKmygYMs.js","assets/analytics.service-24UmsJYf.js","assets/gdocs.service-CaVGXYUm.js","assets/incident.service-B79K0bK8.js","assets/inbox.service-CSnYiWam.js","assets/outbox.service-Db8Bhfap.js","assets/cart.service-B_SpTUv2.js","assets/product.service-iC3Sx6BM.js","assets/product.model-uhuUaOub.js","assets/quote.service-BGOQ22DU.js","assets/quote.model-CvL1ADQq.js","assets/contract.service-DR3D3qAM.js","assets/contract.model-CkFP52sg.js","assets/pricelist.service-Bwtdc_5B.js","assets/pricelist.model-B2sEL8yC.js"])))=>i.map(i=>d[i]);
(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(n){if(n.ep)return;n.ep=!0;const r=t(n);fetch(n.href,r)}})();window.__BASE_URL="/lit-spa/";window.withBase=s=>s?.startsWith("http")?s:"/lit-spa/"+(s||"").replace(/^\//,"");window.go=s=>{window.location.href=window.withBase(s)};document.addEventListener("click",s=>{const e=s.target.closest("a");if(!e)return;const t=e.getAttribute("href");!t||!t.startsWith("/")||e.setAttribute("href",window.withBase(t))},!0);const Ae=sessionStorage.redirect;Ae&&Ae!==location.href&&(sessionStorage.removeItem("redirect"),history.replaceState(null,null,Ae));/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ye=globalThis,se=Ye.trustedTypes,bt=se?se.createPolicy("lit-html",{createHTML:s=>s}):void 0,qt="$lit$",P=`lit$${Math.random().toFixed(9).slice(2)}$`,Ht="?"+P,di=`<${Ht}>`,N=document,G=()=>N.createComment(""),J=s=>s===null||typeof s!="object"&&typeof s!="function",Ke=Array.isArray,ui=s=>Ke(s)||typeof s?.[Symbol.iterator]=="function",Se=`[ 	
\f\r]`,B=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_t=/-->/g,yt=/>/g,k=RegExp(`>|${Se}(?:([^\\s"'>=/]+)(${Se}*=${Se}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),vt=/'/g,wt=/"/g,Vt=/^(?:script|style|textarea|title)$/i,hi=s=>(e,...t)=>({_$litType$:s,strings:e,values:t}),h=hi(1),A=Symbol.for("lit-noChange"),y=Symbol.for("lit-nothing"),Et=new WeakMap,U=N.createTreeWalker(N,129);function Gt(s,e){if(!Ke(s)||!s.hasOwnProperty("raw"))throw Error("invalid template strings array");return bt!==void 0?bt.createHTML(e):e}const pi=(s,e)=>{const t=s.length-1,i=[];let n,r=e===2?"<svg>":e===3?"<math>":"",o=B;for(let a=0;a<t;a++){const c=s[a];let l,p,u=-1,b=0;for(;b<c.length&&(o.lastIndex=b,p=o.exec(c),p!==null);)b=o.lastIndex,o===B?p[1]==="!--"?o=_t:p[1]!==void 0?o=yt:p[2]!==void 0?(Vt.test(p[2])&&(n=RegExp("</"+p[2],"g")),o=k):p[3]!==void 0&&(o=k):o===k?p[0]===">"?(o=n??B,u=-1):p[1]===void 0?u=-2:(u=o.lastIndex-p[2].length,l=p[1],o=p[3]===void 0?k:p[3]==='"'?wt:vt):o===wt||o===vt?o=k:o===_t||o===yt?o=B:(o=k,n=void 0);const f=o===k&&s[a+1].startsWith("/>")?" ":"";r+=o===B?c+di:u>=0?(i.push(l),c.slice(0,u)+qt+c.slice(u)+P+f):c+P+(u===-2?a:f)}return[Gt(s,r+(s[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]};let Ne=class Jt{constructor({strings:e,_$litType$:t},i){let n;this.parts=[];let r=0,o=0;const a=e.length-1,c=this.parts,[l,p]=pi(e,t);if(this.el=Jt.createElement(l,i),U.currentNode=this.el.content,t===2||t===3){const u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(n=U.nextNode())!==null&&c.length<a;){if(n.nodeType===1){if(n.hasAttributes())for(const u of n.getAttributeNames())if(u.endsWith(qt)){const b=p[o++],f=n.getAttribute(u).split(P),v=/([.?@])?(.*)/.exec(b);c.push({type:1,index:r,name:v[2],strings:f,ctor:v[1]==="."?fi:v[1]==="?"?gi:v[1]==="@"?bi:ue}),n.removeAttribute(u)}else u.startsWith(P)&&(c.push({type:6,index:r}),n.removeAttribute(u));if(Vt.test(n.tagName)){const u=n.textContent.split(P),b=u.length-1;if(b>0){n.textContent=se?se.emptyScript:"";for(let f=0;f<b;f++)n.append(u[f],G()),U.nextNode(),c.push({type:2,index:++r});n.append(u[b],G())}}}else if(n.nodeType===8)if(n.data===Ht)c.push({type:2,index:r});else{let u=-1;for(;(u=n.data.indexOf(P,u+1))!==-1;)c.push({type:7,index:r}),u+=P.length-1}r++}}static createElement(e,t){const i=N.createElement("template");return i.innerHTML=e,i}};function D(s,e,t=s,i){if(e===A)return e;let n=i!==void 0?t._$Co?.[i]:t._$Cl;const r=J(e)?void 0:e._$litDirective$;return n?.constructor!==r&&(n?._$AO?.(!1),r===void 0?n=void 0:(n=new r(s),n._$AT(s,t,i)),i!==void 0?(t._$Co??=[])[i]=n:t._$Cl=n),n!==void 0&&(e=D(s,n._$AS(s,e.values),n,i)),e}let mi=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,n=(e?.creationScope??N).importNode(t,!0);U.currentNode=n;let r=U.nextNode(),o=0,a=0,c=i[0];for(;c!==void 0;){if(o===c.index){let l;c.type===2?l=new de(r,r.nextSibling,this,e):c.type===1?l=new c.ctor(r,c.name,c.strings,this,e):c.type===6&&(l=new _i(r,this,e)),this._$AV.push(l),c=i[++a]}o!==c?.index&&(r=U.nextNode(),o++)}return U.currentNode=N,n}p(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},de=class Wt{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,n){this.type=2,this._$AH=y,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=D(this,e,t),J(e)?e===y||e==null||e===""?(this._$AH!==y&&this._$AR(),this._$AH=y):e!==this._$AH&&e!==A&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):ui(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==y&&J(this._$AH)?this._$AA.nextSibling.data=e:this.T(N.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:i}=e,n=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=Ne.createElement(Gt(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===n)this._$AH.p(t);else{const r=new mi(n,this),o=r.u(this.options);r.p(t),this.T(o),this._$AH=r}}_$AC(e){let t=Et.get(e.strings);return t===void 0&&Et.set(e.strings,t=new Ne(e)),t}k(e){Ke(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,n=0;for(const r of e)n===t.length?t.push(i=new Wt(this.O(G()),this.O(G()),this,this.options)):i=t[n],i._$AI(r),n++;n<t.length&&(this._$AR(i&&i._$AB.nextSibling,n),t.length=n)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const i=e.nextSibling;e.remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}};class ue{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,n,r){this.type=1,this._$AH=y,this._$AN=void 0,this.element=e,this.name=t,this._$AM=n,this.options=r,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=y}_$AI(e,t=this,i,n){const r=this.strings;let o=!1;if(r===void 0)e=D(this,e,t,0),o=!J(e)||e!==this._$AH&&e!==A,o&&(this._$AH=e);else{const a=e;let c,l;for(e=r[0],c=0;c<r.length-1;c++)l=D(this,a[i+c],t,c),l===A&&(l=this._$AH[c]),o||=!J(l)||l!==this._$AH[c],l===y?e=y:e!==y&&(e+=(l??"")+r[c+1]),this._$AH[c]=l}o&&!n&&this.j(e)}j(e){e===y?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}let fi=class extends ue{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===y?void 0:e}},gi=class extends ue{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==y)}};class bi extends ue{constructor(e,t,i,n,r){super(e,t,i,n,r),this.type=5}_$AI(e,t=this){if((e=D(this,e,t,0)??y)===A)return;const i=this._$AH,n=e===y&&i!==y||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,r=e!==y&&(i===y||n);n&&this.element.removeEventListener(this.name,this,i),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}let _i=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){D(this,e)}};const Yt={I:de},yi=Ye.litHtmlPolyfillSupport;yi?.(Ne,de),(Ye.litHtmlVersions??=[]).push("3.3.1");const Kt=(s,e,t)=>{const i=t?.renderBefore??e;let n=i._$litPart$;if(n===void 0){const r=t?.renderBefore??null;i._$litPart$=n=new de(e.insertBefore(G(),r),r,void 0,t??{})}return n._$AI(s),n};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Xe=globalThis;let E=class extends T{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Kt(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return A}};E._$litElement$=!0,E.finalized=!0,Xe.litElementHydrateSupport?.({LitElement:E});const vi=Xe.litElementPolyfillSupport;vi?.({LitElement:E});(Xe.litElementVersions??=[]).push("4.2.1");const wi=Object.freeze(Object.defineProperty({__proto__:null,CSSResult:Je,LitElement:E,ReactiveElement:T,_$LH:Yt,adoptStyles:Ft,css:Bt,defaultConverter:te,getCompatibleStyle:Ue,html:h,noChange:A,notEqual:We,nothing:y,render:Kt,supportsAdoptingStyleSheets:ce,unsafeCSS:zt},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const $t=new WeakMap,At=s=>{if((t=>t.pattern!==void 0)(s))return s.pattern;let e=$t.get(s);return e===void 0&&$t.set(s,e=new URLPattern({pathname:s.path})),e};let Ei=class{constructor(e,t,i){this.routes=[],this.o=[],this.t={},this.i=n=>{if(n.routes===this)return;const r=n.routes;this.o.push(r),r.h=this,n.stopImmediatePropagation(),n.onDisconnect=()=>{this.o?.splice(this.o.indexOf(r)>>>0,1)};const o=St(this.t);o!==void 0&&r.goto(o)},(this.l=e).addController(this),this.routes=[...t],this.fallback=i?.fallback}link(e){if(e?.startsWith("/"))return e;if(e?.startsWith("."))throw Error("Not implemented");return e??=this.u,(this.h?.link()??"")+e}async goto(e){let t;if(this.routes.length===0&&this.fallback===void 0)t=e,this.u="",this.t={0:t};else{const i=this.p(e);if(i===void 0)throw Error("No route found for "+e);const n=At(i).exec({pathname:e}),r=n?.pathname.groups??{};if(t=St(r),typeof i.enter=="function"&&await i.enter(r)===!1)return;this.v=i,this.t=r,this.u=t===void 0?e:e.substring(0,e.length-t.length)}if(t!==void 0)for(const i of this.o)i.goto(t);this.l.requestUpdate()}outlet(){return this.v?.render?.(this.t)}get params(){return this.t}p(e){const t=this.routes.find(i=>At(i).test({pathname:e}));return t||this.fallback===void 0?t:this.fallback?{...this.fallback,path:"/*"}:void 0}hostConnected(){this.l.addEventListener(Le.eventName,this.i);const e=new Le(this);this.l.dispatchEvent(e),this._=e.onDisconnect}hostDisconnected(){this._?.(),this.h=void 0}};const St=s=>{let e;for(const t of Object.keys(s))/\d+/.test(t)&&(e===void 0||t>e)&&(e=t);return e&&s[e]};let Le=class Xt extends Event{constructor(e){super(Xt.eventName,{bubbles:!0,composed:!0,cancelable:!1}),this.routes=e}};Le.eventName="lit-routes-connected";/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const $i=location.origin||location.protocol+"//"+location.host;let xt=class extends Ei{constructor(){super(...arguments),this.m=e=>{const t=e.button!==0||e.metaKey||e.ctrlKey||e.shiftKey;if(e.defaultPrevented||t)return;const i=e.composedPath().find(o=>o.tagName==="A");if(i===void 0||i.target!==""||i.hasAttribute("download")||i.getAttribute("rel")==="external")return;const n=i.href;if(n===""||n.startsWith("mailto:"))return;const r=window.location;i.origin===$i&&(e.preventDefault(),n!==r.href&&(window.history.pushState({},"",n),this.goto(i.pathname)))},this.R=e=>{this.goto(window.location.pathname)}}hostConnected(){super.hostConnected(),window.addEventListener("click",this.m),window.addEventListener("popstate",this.R),this.goto(window.location.pathname)}hostDisconnected(){super.hostDisconnected(),window.removeEventListener("click",this.m),window.removeEventListener("popstate",this.R)}};const Ai="modulepreload",Si=function(s){return"/lit-spa/"+s},Rt={},g=function(e,t,i){let n=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),a=o?.nonce||o?.getAttribute("nonce");n=Promise.allSettled(t.map(c=>{if(c=Si(c),c in Rt)return;Rt[c]=!0;const l=c.endsWith(".css"),p=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${p}`))return;const u=document.createElement("link");if(u.rel=l?"stylesheet":Ai,l||(u.as="script"),u.crossOrigin="",u.href=c,a&&u.setAttribute("nonce",a),document.head.appendChild(u),l)return new Promise((b,f)=>{u.addEventListener("load",b),u.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(o){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=o,window.dispatchEvent(a),!a.defaultPrevented)throw o}return n.then(o=>{for(const a of o||[])a.status==="rejected"&&r(a.reason);return e().catch(r)})},xi=300,Zt=!0,Ri="/src/mocks";async function he(s,e={}){try{Zt&&await new Promise(r=>setTimeout(r,xi));const t=`${Ri}${s}`,i=localStorage.getItem("auth_token"),n=await fetch(t,{...e,headers:{"Content-Type":"application/json",Authorization:i?`Bearer ${i}`:"",...e.headers}});if(!n.ok)throw new Error(`API Error: ${n.status} ${n.statusText}`);return await n.json()}catch(t){throw console.error("API Request Error:",t),t}}async function pe(s){return he(s,{method:"GET"})}async function Ci(s,e){return he(s,{method:"POST",body:JSON.stringify(e)})}async function Oi(s,e){return he(s,{method:"PUT",body:JSON.stringify(e)})}async function Ii(s){return he(s,{method:"DELETE"})}const Qt=s=>new Promise(e=>setTimeout(e,s));function Pi(){return Zt}const ki=Object.freeze(Object.defineProperty({__proto__:null,del:Ii,delay:Qt,get:pe,isMockMode:Pi,post:Ci,put:Oi},Symbol.toStringTag,{value:"Module"}));class Mi extends Error{}Mi.prototype.name="InvalidTokenError";var ie=(s=>(s[s.NONE=0]="NONE",s[s.ERROR=1]="ERROR",s[s.WARN=2]="WARN",s[s.INFO=3]="INFO",s[s.DEBUG=4]="DEBUG",s))(ie||{});(s=>{function e(){}s.reset=e;function t(n){if(!(0<=n&&n<=4))throw new Error("Invalid log level")}s.setLevel=t;function i(n){}s.setLogger=i})(ie||(ie={}));ie.reset();function Ti(){return null}function Ui(){return Ti()}async function Ni(){const s=Ui();if(!s)throw new Error("OIDC is not enabled");return await s.signinRedirectCallback()}function Li(s){if(!s)return null;const e=s.profile;return{id:e.sub||e.user_id||e.id,username:e.preferred_username||e.username||e.email,email:e.email,name:e.name||e.given_name+" "+e.family_name,role:e.role||e.roles?.[0]||"user",assignedRoles:e.roles||e.role?[e.role]:[],oidcProfile:e,accessToken:s.access_token,idToken:s.id_token,tokenType:s.token_type,expiresAt:s.expires_at}}const Ze="auth_token",Qe="auth_user";let xe=null;async function Di(){return xe||(xe=await pe("/authUsers.json")),xe}function ji(s){const e=btoa(JSON.stringify({alg:"HS256",typ:"JWT"})),t=btoa(JSON.stringify({userId:s.id,username:s.username,email:s.email,role:s.role,name:s.name,exp:Date.now()+24*60*60*1e3})),i=btoa("mock-signature");return`${e}.${t}.${i}`}function zi(s){try{const e=s.split(".");if(e.length!==3)return null;const t=JSON.parse(atob(e[1]));return t.exp&&t.exp<Date.now()?null:t}catch{return null}}async function Bi(s,e){const i=(await Di()).find(f=>f.username===s&&f.password===e);if(!i)throw new Error("Invalid username or password");const{getUsers:n}=await g(async()=>{const{getUsers:f}=await Promise.resolve().then(()=>Ys);return{getUsers:f}},void 0),r=await n(),a=r.find(f=>f.id===i.id)?.assignedRoles||[],c=ji(i),l={id:i.id,username:i.username,email:i.email,role:i.role,name:i.name,assignedRoles:a};localStorage.setItem(Ze,c),localStorage.setItem(Qe,JSON.stringify(l));const{getRoles:p}=await g(async()=>{const{getRoles:f}=await Promise.resolve().then(()=>Js);return{getRoles:f}},void 0),{initializePermissionCache:u}=await g(async()=>{const{initializePermissionCache:f}=await Promise.resolve().then(()=>Fe);return{initializePermissionCache:f}},void 0),b=await p();return await u(r,b),{token:c,user:l}}async function Fi(){try{localStorage.removeItem("impersonation_state")}catch{}localStorage.removeItem(Ze),localStorage.removeItem(Qe)}function qi(){return localStorage.getItem(Ze)}function x(){try{const t=localStorage.getItem("impersonation_state");if(t){const i=JSON.parse(t);if(i.isImpersonating&&i.impersonatedUser)return i.impersonatedUser}}catch{}const s=localStorage.getItem(Qe);if(!s)return null;try{return JSON.parse(s)}catch{return null}}async function fo(){return x()}function me(){const s=qi();return s?zi(s)!==null:!1}async function go(){return me()}function bo(){return!!me()}async function Hi(){return x()}let es=class{constructor(e,t){this.operator=e,this.value=t,Object.defineProperty(this,"t",{writable:!0})}get notes(){return this.t}addNote(e){this.t=this.t||[],this.t.push(e)}},et=class extends es{},fe=class extends et{constructor(e,t){if(!Array.isArray(t))throw new Error(`"${e}" operator expects to receive an array of conditions`);super(e,t)}};const W="__itself__";let ge=class extends es{constructor(e,t,i){super(e,i),this.field=t}};const ts=new et("__null__",null),De=Object.prototype.hasOwnProperty.call.bind(Object.prototype.hasOwnProperty);function Vi(s,e){return e instanceof fe&&e.operator===s}function ss(s,e){return e.length===1?e[0]:new fe(s,function t(i,n,r){const o=r||[];for(let a=0,c=n.length;a<c;a++){const l=n[a];Vi(i,l)?t(i,l.value,o):o.push(l)}return o}(s,e))}const Gi=s=>s,is=()=>Object.create(null),ns=Object.defineProperty(is(),"__@type@__",{value:"ignore value"});function Ji(s,e,t=!1){if(!s||s&&s.constructor!==Object)return!1;for(const i in s)if(De(s,i)&&De(e,i)&&(!t||s[i]!==ns))return!0;return!1}function Wi(s){const e=[];for(const t in s)De(s,t)&&s[t]!==ns&&e.push(t);return e}function Re(s,e){e!==ts&&s.push(e)}const rs=s=>ss("and",s),os={compound(s,e,t){const i=(Array.isArray(e)?e:[e]).map(n=>t.parse(n));return new fe(s.name,i)},field:(s,e,t)=>new ge(s.name,t.field,e),document:(s,e)=>new et(s.name,e)};let Yi=class{constructor(e,t=is()){this.o=void 0,this.s=void 0,this.i=void 0,this.u=void 0,this.h=void 0,this.parse=this.parse.bind(this),this.u={operatorToConditionName:t.operatorToConditionName||Gi,defaultOperatorName:t.defaultOperatorName||"eq",mergeFinalConditions:t.mergeFinalConditions||rs},this.o=Object.keys(e).reduce((i,n)=>(i[n]=Object.assign({name:this.u.operatorToConditionName(n)},e[n]),i),{}),this.s=Object.assign({},t.fieldContext,{field:"",query:{},parse:this.parse,hasOperators:i=>Ji(i,this.o,t.useIgnoreValue)}),this.i=Object.assign({},t.documentContext,{parse:this.parse,query:{}}),this.h=t.useIgnoreValue?Wi:Object.keys}setParse(e){this.parse=e,this.s.parse=e,this.i.parse=e}parseField(e,t,i,n){const r=this.o[t];if(!r)throw new Error(`Unsupported operator "${t}"`);if(r.type!=="field")throw new Error(`Unexpected ${r.type} operator "${t}" at field level`);return this.s.field=e,this.s.query=n,this.parseInstruction(r,i,this.s)}parseInstruction(e,t,i){return typeof e.validate=="function"&&e.validate(e,t),(e.parse||os[e.type])(e,t,i)}parseFieldOperators(e,t){const i=[],n=this.h(t);for(let r=0,o=n.length;r<o;r++){const a=n[r];if(!this.o[a])throw new Error(`Field query for "${e}" may contain only operators or a plain object as a value`);Re(i,this.parseField(e,a,t[a],t))}return i}parse(e){const t=[],i=this.h(e);this.i.query=e;for(let n=0,r=i.length;n<r;n++){const o=i[n],a=e[o],c=this.o[o];if(c){if(c.type!=="document"&&c.type!=="compound")throw new Error(`Cannot use parsing instruction for operator "${o}" in "document" context as it is supposed to be used in  "${c.type}" context`);Re(t,this.parseInstruction(c,a,this.i))}else this.s.hasOperators(a)?t.push(...this.parseFieldOperators(o,a)):Re(t,this.parseField(o,this.u.defaultOperatorName,a,e))}return this.u.mergeFinalConditions(t)}};function Ce(s,e){const t=s[e];if(typeof t!="function")throw new Error(`Unable to interpret "${e}" condition. Did you forget to register interpreter for it?`);return t}function Ki(s){return s.operator}function Xi(s,e){const t=e,i=t&&t.getInterpreterName||Ki;let n;switch(t?t.numberOfArguments:0){case 1:n=o=>{const a=i(o,t);return Ce(s,a)(o,r)};break;case 3:n=(o,a,c)=>{const l=i(o,t);return Ce(s,l)(o,a,c,r)};break;default:n=(o,a)=>{const c=i(o,t);return Ce(s,c)(o,a,r)}}const r=Object.assign({},t,{interpret:n});return r.interpret}function Zi(s,e){return(t,...i)=>{const n=s(t,...i),r=e.bind(null,n);return r.ast=n,r}}function as(s,e){if(!Array.isArray(e))throw new Error(`"${s.name}" expects value to be an array`)}function cs(s,e){if(as(s,e),!e.length)throw new Error(`"${s.name}" expects to have at least one element in array`)}const tt=s=>(e,t)=>{if(typeof t!==s)throw new Error(`"${e.name}" expects value to be a "${s}"`)},ls={type:"compound",validate:cs,parse(s,e,{parse:t}){const i=e.map(n=>t(n));return ss(s.name,i)}},Qi=ls,en={type:"compound",validate:cs},tn={type:"field",validate(s,e){if(!(e&&(e instanceof RegExp||e.constructor===Object)))throw new Error(`"${s.name}" expects to receive either regular expression or object of field operators`)},parse(s,e,t){const i=e instanceof RegExp?new ge("regex",t.field,e):t.parse(e,t);return new fe(s.name,[i])}},ds={type:"field",validate(s,e){if(!e||e.constructor!==Object)throw new Error(`"${s.name}" expects to receive an object with nested query or field level operators`)},parse(s,e,{parse:t,field:i,hasOperators:n}){const r=n(e)?t(e,{field:W}):t(e);return new ge(s.name,i,r)}},us={type:"field",validate:tt("number")},be={type:"field",validate:as},hs=be,ps=be,sn={type:"field",validate(s,e){if(!Array.isArray(e)||e.length!==2)throw new Error(`"${s.name}" expects an array with 2 numeric elements`)}},ms={type:"field",validate:tt("boolean")},st={type:"field",validate:function(s,e){if(!(typeof e=="string"||typeof e=="number"||e instanceof Date))throw new Error(`"${s.name}" expects value to be comparable (i.e., string, number or date)`)}},_e=st,fs=_e,gs=_e,it={type:"field"},bs=it,_s={type:"field",validate(s,e){if(!(e instanceof RegExp)&&typeof e!="string")throw new Error(`"${s.name}" expects value to be a regular expression or a string that represents regular expression`)},parse(s,e,t){const i=typeof e=="string"?new RegExp(e,t.query.$options||""):e;return new ge(s.name,t.field,i)}},ys={type:"field",parse:()=>ts},nn={type:"document",validate:tt("function")};var rn=Object.freeze({__proto__:null,$and:ls,$or:Qi,$nor:en,$not:tn,$elemMatch:ds,$size:us,$in:be,$nin:hs,$all:ps,$mod:sn,$exists:ms,$gte:st,$gt:_e,$lt:fs,$lte:gs,$eq:it,$ne:bs,$regex:_s,$options:ys,$where:nn});let on=class extends Yi{constructor(e){super(e,{defaultOperatorName:"$eq",operatorToConditionName:t=>t.slice(1)})}parse(e,t){return t&&t.field?rs(this.parseFieldOperators(t.field,e)):super.parse(e)}};const je=rn;function nt(s,e,t){for(let i=0,n=s.length;i<n;i++)if(t(s[i],e)===0)return!0;return!1}function rt(s,e){return Array.isArray(s)&&Number.isNaN(Number(e))}function Ct(s,e,t){if(!rt(s,e))return t(s,e);let i=[];for(let n=0;n<s.length;n++){const r=t(s[n],e);r!==void 0&&(i=i.concat(r))}return i}function L(s){return(e,t,i)=>{const n=i.get(t,e.field);return Array.isArray(n)?n.some(r=>s(e,r,i)):s(e,n,i)}}const an=(s,e)=>s[e];function vs(s,e,t){const i=e.lastIndexOf(".");return i===-1?[s,e]:[t(s,e.slice(0,i)),e.slice(i+1)]}function cn(s,e,t=an){if(e===W)return s;if(!s)throw new Error(`Unable to get field "${e}" out of ${String(s)}.`);return function(i,n,r){if(n.indexOf(".")===-1)return Ct(i,n,r);const o=n.split(".");let a=i;for(let c=0,l=o.length;c<l;c++)if(a=Ct(a,o[c],r),!a||typeof a!="object")return a;return a}(s,e,t)}function ws(s,e){return s===e?0:s>e?1:-1}function Es(s,e={}){return Xi(s,Object.assign({get:cn,compare:ws},e))}const $s=(s,e,{interpret:t})=>s.value.some(i=>t(i,e)),ln=(s,e,t)=>!$s(s,e,t),As=(s,e,{interpret:t})=>s.value.every(i=>t(i,e)),dn=(s,e,{interpret:t})=>!t(s.value[0],e),ot=(s,e,{compare:t,get:i})=>{const n=i(e,s.field);return Array.isArray(n)&&!Array.isArray(s.value)?nt(n,s.value,t):t(n,s.value)===0},Ss=(s,e,t)=>!ot(s,e,t),xs=L((s,e,t)=>{const i=t.compare(e,s.value);return i===0||i===-1}),Rs=L((s,e,t)=>t.compare(e,s.value)===-1),Cs=L((s,e,t)=>t.compare(e,s.value)===1),Os=L((s,e,t)=>{const i=t.compare(e,s.value);return i===0||i===1}),Is=(s,e,{get:t})=>{if(s.field===W)return e!==void 0;const[i,n]=vs(e,s.field,t),r=o=>o==null?!!o===s.value:o.hasOwnProperty(n)===s.value;return rt(i,n)?i.some(r):r(i)},un=L((s,e)=>typeof e=="number"&&e%s.value[0]===s.value[1]),Ps=(s,e,{get:t})=>{const[i,n]=vs(e,s.field,t),r=o=>{const a=t(o,n);return Array.isArray(a)&&a.length===s.value};return s.field!==W&&rt(i,n)?i.some(r):r(i)},ks=L((s,e)=>typeof e=="string"&&s.value.test(e)),ye=L((s,e,{compare:t})=>nt(s.value,e,t)),Ms=(s,e,t)=>!ye(s,e,t),Ts=(s,e,{compare:t,get:i})=>{const n=i(e,s.field);return Array.isArray(n)&&s.value.every(r=>nt(n,r,t))},Us=(s,e,{interpret:t,get:i})=>{const n=i(e,s.field);return Array.isArray(n)&&n.some(r=>t(s.value,r))},hn=(s,e)=>s.value.call(e);var pn=Object.freeze({__proto__:null,or:$s,nor:ln,and:As,not:dn,eq:ot,ne:Ss,lte:xs,lt:Rs,gt:Cs,gte:Os,exists:Is,mod:un,size:Ps,regex:ks,within:ye,nin:Ms,all:Ts,elemMatch:Us,where:hn});const at=Object.assign({},pn,{in:ye});Es(at);function Ot(s){return s===null||typeof s!="object"?s:s instanceof Date?s.getTime():s&&typeof s.toJSON=="function"?s.toJSON():s}const mn=(s,e)=>ws(Ot(s),Ot(e));function ct(s,e,t){const i=new on(s),n=Es(e,Object.assign({compare:mn},t));if(t&&t.forPrimitives){const r={field:W},o=i.parse;i.setParse(a=>o(a,r))}return Zi(i.parse,n)}ct(je,at);ct(["$and","$or"].reduce((s,e)=>(s[e]=Object.assign({},s[e],{type:"field"}),s),Object.assign({},je,{$nor:Object.assign({},je.$nor,{type:"field",parse:os.compound})})),at,{forPrimitives:!0});function ze(s){return Array.isArray(s)?s:[s]}const It="__caslSubjectType__",Q=s=>{const e=typeof s;return e==="string"||e==="function"},fn=s=>s.modelName||s.name;function Ns(s){return Object.hasOwn(s,It)?s[It]:fn(s.constructor)}const Pt={function:s=>s.constructor,string:Ns};function kt(s,e,t){for(let i=t;i<e.length;i++)s.push(e[i])}function Mt(s,e){if(!s||!s.length)return e||[];if(!e||!e.length)return s||[];let t=0,i=0;const n=[];for(;t<s.length&&i<e.length;)s[t].priority<e[i].priority?(n.push(s[t]),t++):(n.push(e[i]),i++);return kt(n,s,t),kt(n,e,i),n}function X(s,e,t){let i=s.get(e);return i||(i=t(),s.set(e,i)),i}const gn=s=>s;function bn(s,e){if(Array.isArray(s.fields)&&!s.fields.length)throw new Error("`rawRule.fields` cannot be an empty array. https://bit.ly/390miLa");if(s.fields&&!e.fieldMatcher)throw new Error('You need to pass "fieldMatcher" option in order to restrict access by fields');if(s.conditions&&!e.conditionsMatcher)throw new Error('You need to pass "conditionsMatcher" option in order to restrict access by conditions')}class _n{constructor(e,t,i=0){bn(e,t),this.action=t.resolveAction(e.action),this.subject=e.subject,this.inverted=!!e.inverted,this.conditions=e.conditions,this.reason=e.reason,this.origin=e,this.fields=e.fields?ze(e.fields):void 0,this.priority=i,this.t=t}i(){return this.conditions&&!this.o&&(this.o=this.t.conditionsMatcher(this.conditions)),this.o}get ast(){const e=this.i();return e?e.ast:void 0}matchesConditions(e){return this.conditions?!e||Q(e)?!this.inverted:this.i()(e):!0}matchesField(e){return this.fields?e?(this.u||(this.u=this.t.fieldMatcher(this.fields)),this.u(e)):!this.inverted:!0}}function yn(s,e){const t={value:s,prev:e,next:null};return e&&(e.next=t),t}function vn(s){s.next&&(s.next.prev=s.prev),s.prev&&(s.prev.next=s.next),s.next=s.prev=null}const wn=s=>({value:s.value,prev:s.prev,next:s.next}),Tt=()=>({rules:[],merged:!1}),Ut=()=>new Map;class En{constructor(e=[],t={}){this.h=!1,this.l=new Map,this.p={conditionsMatcher:t.conditionsMatcher,fieldMatcher:t.fieldMatcher,resolveAction:t.resolveAction||gn},this.$=t.anyAction||"manage",this.A=t.anySubjectType||"all",this.m=e,this.M=!!t.detectSubjectType,this.j=t.detectSubjectType||Ns,this.v(e)}get rules(){return this.m}detectSubjectType(e){return Q(e)?e:e?this.j(e):this.A}update(e){const t={rules:e,ability:this,target:this};return this._("update",t),this.m=e,this.v(e),this._("updated",t),this}v(e){const t=new Map;let i;for(let n=e.length-1;n>=0;n--){const r=e.length-n-1,o=new _n(e[n],this.p,r),a=ze(o.action),c=ze(o.subject||this.A);!this.h&&o.fields&&(this.h=!0);for(let l=0;l<c.length;l++){const p=X(t,c[l],Ut);i===void 0&&(i=typeof c[l]),typeof c[l]!==i&&i!=="mixed"&&(i="mixed");for(let u=0;u<a.length;u++)X(p,a[u],Tt).rules.push(o)}}if(this.l=t,i!=="mixed"&&!this.M){const n=Pt[i]||Pt.string;this.j=n}}possibleRulesFor(e,t=this.A){if(!Q(t))throw new Error('"possibleRulesFor" accepts only subject types (i.e., string or class) as the 2nd parameter');const i=X(this.l,t,Ut),n=X(i,e,Tt);if(n.merged)return n.rules;const r=e!==this.$&&i.has(this.$)?i.get(this.$).rules:void 0;let o=Mt(n.rules,r);return t!==this.A&&(o=Mt(o,this.possibleRulesFor(e,this.A))),n.rules=o,n.merged=!0,o}rulesFor(e,t,i){const n=this.possibleRulesFor(e,t);if(i&&typeof i!="string")throw new Error("The 3rd, `field` parameter is expected to be a string. See https://stalniy.github.io/casl/en/api/casl-ability#can-of-pure-ability for details");return this.h?n.filter(r=>r.matchesField(i)):n}actionsFor(e){if(!Q(e))throw new Error('"actionsFor" accepts only subject types (i.e., string or class) as a parameter');const t=new Set,i=this.l.get(e);i&&Array.from(i.keys()).forEach(r=>t.add(r));const n=e!==this.A?this.l.get(this.A):void 0;return n&&Array.from(n.keys()).forEach(r=>t.add(r)),Array.from(t)}on(e,t){this.F=this.F||new Map;const i=this.F,n=i.get(e)||null,r=yn(t,n);return i.set(e,r),()=>{const o=i.get(e);!r.next&&!r.prev&&o===r?i.delete(e):r===o&&i.set(e,r.prev),vn(r)}}_(e,t){if(!this.F)return;let i=this.F.get(e)||null;for(;i!==null;){const n=i.prev?wn(i.prev):null;i.value(t),i=n}}}class $n extends En{can(e,t,i){const n=this.relevantRuleFor(e,t,i);return!!n&&!n.inverted}relevantRuleFor(e,t,i){const n=this.detectSubjectType(t),r=this.rulesFor(e,n,i);for(let o=0,a=r.length;o<a;o++)if(r[o].matchesConditions(t))return r[o];return null}cannot(e,t,i){return!this.can(e,t,i)}}const An={$eq:it,$ne:bs,$lt:fs,$lte:gs,$gt:_e,$gte:st,$in:be,$nin:hs,$all:ps,$size:us,$regex:_s,$options:ys,$elemMatch:ds,$exists:ms},Sn={eq:ot,ne:Ss,lt:Rs,lte:xs,gt:Cs,gte:Os,in:ye,nin:Ms,all:Ts,size:Ps,regex:ks,elemMatch:Us,exists:Is,and:As},xn=ct(An,Sn),Rn=/[-/\\^$+?.()|[\]{}]/g,Cn=/\.?\*+\.?/g,On=/\*+/,In=/\./g;function Pn(s,e,t){const i=t[0]==="*"||s[0]==="."&&s[s.length-1]==="."?"+":"*",n=s.indexOf("**")===-1?"[^.]":".",r=s.replace(In,"\\$&").replace(On,n+i);return e+s.length===t.length?`(?:${r})?`:r}function kn(s,e,t){return s==="."&&(t[e-1]==="*"||t[e+1]==="*")?s:`\\${s}`}function Mn(s){const e=s.map(i=>i.replace(Rn,kn).replace(Cn,Pn)),t=e.length>1?`(?:${e.join("|")})`:e[0];return new RegExp(`^${t}$`)}const Tn=s=>{let e;return t=>(typeof e>"u"&&(e=s.every(i=>i.indexOf("*")===-1)?null:Mn(s)),e===null?s.indexOf(t)!==-1:e.test(t))};function Un(s=[],e={}){return new $n(s,Object.assign({conditionsMatcher:xn,fieldMatcher:Tn},e))}function Nn(s){return s.prototype!==void 0&&typeof s.prototype.possibleRulesFor=="function"}class Ln{constructor(e){this.O=e}because(e){return this.O.reason=e,this}}class Dn{constructor(e){this.rules=[],this.C=e,this.can=(t,i,n,r)=>this.R(t,i,n,r,!1),this.cannot=(t,i,n,r)=>this.R(t,i,n,r,!0),this.build=t=>Nn(this.C)?new this.C(this.rules,t):this.C(this.rules,t)}R(e,t,i,n,r){const o={action:e};return r&&(o.inverted=r),t&&(o.subject=t,Array.isArray(i)||typeof i=="string"?o.fields=i:typeof i<"u"&&(o.conditions=i),typeof n<"u"&&(o.conditions=n)),this.rules.push(o),new Ln(o)}}const m={CREATE:"create",READ:"read",UPDATE:"update",DELETE:"delete",MANAGE:"manage",EXECUTE:"execute",EXPORT:"export",IMPORT:"import",APPROVE:"approve",REJECT:"reject",PUBLISH:"publish"},d={USER:"User",ROLE:"Role",PERMISSION:"Permission",CUSTOMER:"Customer",ORGANIZATION:"Organization",ORDER:"Order",PRODUCT:"Product",INVOICE:"Invoice",QUOTE:"Quote",CONTRACT:"Contract",PRICELIST:"PriceList",PURCHASE_ORDER:"PurchaseOrder",INCIDENT:"Incident",SLA_METRIC:"SLAMetric",REPORT:"Report",DASHBOARD:"Dashboard",ANALYTICS:"Analytics",DOCUMENT:"Document",INBOX:"Inbox",OUTBOX:"Outbox",SETTINGS:"Settings",MODULE:"Module",ALL:"all"};function ne(s,e=[]){const{can:t,cannot:i,build:n}=new Dn(Un);if(!s)return t(m.READ,d.PRODUCT),n();if(s.role==="Super Admin"||s.isSuperAdmin)return t(m.MANAGE,d.ALL),n();switch(e.forEach(r=>{!r||!r.permissions||Object.entries(r.permissions).forEach(([o,a])=>{const c=jn(o);a.forEach(l=>{t(l==="manage"?m.MANAGE:l,c)})})}),s.role){case"Admin":t(m.MANAGE,[d.USER,d.CUSTOMER,d.ORDER,d.PRODUCT,d.INCIDENT]),t(m.READ,d.SETTINGS);break;case"Manager":t([m.READ,m.UPDATE],[d.CUSTOMER,d.ORDER,d.PRODUCT,d.INCIDENT]),t(m.CREATE,[d.ORDER,d.INCIDENT]),t(m.APPROVE,d.ORDER);break;case"User":t(m.READ,[d.CUSTOMER,d.ORDER,d.PRODUCT,d.REPORT]),t([m.CREATE,m.UPDATE],d.INCIDENT);break;case"Customer":t(m.READ,[d.PRODUCT,d.ORDER,d.INVOICE]),t(m.CREATE,[d.ORDER,d.QUOTE]),t(m.UPDATE,d.ORDER,{status:"draft"});break}return t(m.UPDATE,d.USER,{id:s.id}),s.role==="User"&&(t(m.READ,d.INCIDENT,{assignedTo:s.id}),t(m.READ,d.INCIDENT,{reportedBy:s.id})),n()}function jn(s){return{users:d.USER,roles:d.ROLE,permissions:d.PERMISSION,settings:d.SETTINGS,customers:d.CUSTOMER,customer_orgs:d.ORGANIZATION,orders:d.ORDER,products:d.PRODUCT,incidents:d.INCIDENT,reports:d.REPORT,analytics:d.ANALYTICS,documents:d.DOCUMENT,invoices:d.INVOICE,quotes:d.QUOTE,contracts:d.CONTRACT,pricelists:d.PRICELIST,purchase_orders:d.PURCHASE_ORDER,sla_metrics:d.SLA_METRIC,inbox:d.INBOX,outbox:d.OUTBOX,dashboards:d.DASHBOARD,modules:d.MODULE}[s]||s}class zn{constructor(){this._ability=null,this._user=null}init(e,t=[]){this._user=e,this._ability=ne(e,t)}get ability(){return this._ability||(this._ability=ne(null)),this._ability}can(e,t,i){return this.ability.can(e,t,i)}cannot(e,t,i){return this.ability.cannot(e,t,i)}update(e,t=[]){this.init(e,t)}clear(){this._ability=null,this._user=null}getRules(){return this.ability.rules}isAdmin(){return this.can(m.MANAGE,d.ALL)}canAccessRoute(e){const t={"/users":{action:m.READ,subject:d.USER},"/users/new":{action:m.CREATE,subject:d.USER},"/users/edit":{action:m.UPDATE,subject:d.USER},"/roles":{action:m.READ,subject:d.ROLE},"/roles/new":{action:m.CREATE,subject:d.ROLE},"/roles/edit":{action:m.UPDATE,subject:d.ROLE},"/customers":{action:m.READ,subject:d.CUSTOMER},"/customers/new":{action:m.CREATE,subject:d.CUSTOMER},"/customers/edit":{action:m.UPDATE,subject:d.CUSTOMER},"/orders":{action:m.READ,subject:d.ORDER},"/orders/new":{action:m.CREATE,subject:d.ORDER},"/products":{action:m.READ,subject:d.PRODUCT},"/sla/incidents":{action:m.READ,subject:d.INCIDENT},"/sla/incidents/new":{action:m.CREATE,subject:d.INCIDENT},"/reports":{action:m.READ,subject:d.REPORT},"/analytics":{action:m.READ,subject:d.ANALYTICS}},i=Object.keys(t).find(o=>e.startsWith(o));if(!i)return!0;const{action:n,subject:r}=t[i];return this.can(n,r)}getPermissionsSummary(){return{canManageUsers:this.can(m.MANAGE,d.USER),canManageRoles:this.can(m.MANAGE,d.ROLE),canManageCustomers:this.can(m.MANAGE,d.CUSTOMER),canManageOrders:this.can(m.MANAGE,d.ORDER),canManageProducts:this.can(m.MANAGE,d.PRODUCT),canManageIncidents:this.can(m.MANAGE,d.INCIDENT),canViewReports:this.can(m.READ,d.REPORT),canViewAnalytics:this.can(m.READ,d.ANALYTICS),isAdmin:this.isAdmin()}}}const _=new zn,Bn=Object.freeze(Object.defineProperty({__proto__:null,Actions:m,Subjects:d,_defineAbilityFor:ne,abilityService:_,defineAbilityFor:ne},Symbol.toStringTag,{value:"Module"})),Ao=Qt,Be=[{id:"admin",name:"Admin",icon:"shield-lock",color:"danger",description:"System administration and user management",requiredRoles:[1],entities:["users","roles"]},{id:"sla",name:"SLA",icon:"speedometer2",color:"primary",description:"Service Level Agreement monitoring and incident management",requiredRoles:[1,2],entities:["incidents"]},{id:"sales",name:"Sales",icon:"cart-check",color:"success",description:"Sales and order management",requiredRoles:[1,3],entities:["orders","customers","products"]},{id:"analytics",name:"Analytics",icon:"graph-up",color:"info",description:"Business intelligence and reports",requiredRoles:[1,2],entities:["reports"]},{id:"gdocs",name:"Gdocs",icon:"file-earmark-text",color:"secondary",description:"Document management and collaboration",requiredRoles:[1,2],entities:["gdocs"]},{id:"commerce",name:"Commerce",icon:"shop",color:"success",description:"Unified B2C and B2B e-commerce platform",requiredRoles:[1,2],entities:["products","orders","customers","quotes"]},{id:"customers",name:"Customers",icon:"building",color:"success",description:"Customer and organization management",requiredRoles:[1,2],entities:["customers","customer_orgs"]},{id:"companies",name:"Companies",icon:"building",color:"primary",description:"B2B companies and business partners",requiredRoles:[1,2],entities:["companies"]}],Ls=[{id:"users",name:"Users",icon:"people",description:"User accounts and profiles"},{id:"incidents",name:"Incidents",icon:"exclamation-triangle",description:"SLA incident tracking and management"},{id:"products",name:"Products",icon:"box",description:"Product catalog management"},{id:"orders",name:"Orders",icon:"cart",description:"Order processing and tracking"},{id:"customers",name:"Customers",icon:"person-badge",description:"Customer relationship management"},{id:"customer_orgs",name:"Customer Organizations",icon:"building",description:"Customer organization management (multi-tenant)"},{id:"companies",name:"Companies",icon:"building",description:"B2B companies and business partners"},{id:"quotes",name:"Quotes",icon:"file-earmark-text",description:"B2B quotes and RFQs"},{id:"purchase_orders",name:"Purchase Orders",icon:"receipt",description:"B2B purchase orders"},{id:"reports",name:"Reports",icon:"file-earmark-bar-graph",description:"Analytics and reporting"},{id:"settings",name:"Settings",icon:"gear",description:"System configuration"},{id:"gdocs",name:"Gdocs",icon:"file-earmark-text",description:"Document management and collaboration"},{id:"pages",name:"Pages",icon:"file-earmark",description:"Website page management"},{id:"blog",name:"Blog",icon:"journal-text",description:"Blog post management"},{id:"media",name:"Media",icon:"image",description:"Media file management"}],Fn=[{id:"create",name:"Create",icon:"plus-circle",color:"success"},{id:"read",name:"Read",icon:"eye",color:"info"},{id:"update",name:"Update",icon:"pencil",color:"warning"},{id:"delete",name:"Delete",icon:"trash",color:"danger"}];async function qn(){return{title:"Welcome",intro:"This data is provided by the service layer.",items:[{id:1,text:"Lit components render fast"},{id:2,text:"Routing via @lit-labs/router"},{id:3,text:"Vite for dev and build"}]}}async function So(){return{framework:"Lit",version:"3.x",features:["Web Components based","Small and fast","Declarative templates"],links:[{label:"Docs",href:"https://lit.dev"},{label:"Router",href:"https://github.com/lit/lit/tree/main/packages/labs/router"}]}}async function lt(s,e=[]){_.init(s,e),typeof window<"u"&&(window.__ability=_.ability)}function R(s,e,t=null){const i=Hn(s);return _.can(e,i,t)}function Ds(s,e){return e.some(t=>R(s,t))}function js(s,e){return e.every(t=>R(s,t))}function Y(s){return _.canAccessRoute(s)}function zs(){return _.isAdmin()}function Bs(){return _.getPermissionsSummary()}function Hn(s){return{users:d.USER,roles:d.ROLE,permissions:d.PERMISSION,settings:d.SETTINGS,customers:d.CUSTOMER,customer_orgs:d.ORGANIZATION,orders:d.ORDER,products:d.PRODUCT,incidents:d.INCIDENT,reports:d.REPORT,analytics:d.ANALYTICS}[s]||s}function Vn(s,e){return function(t){return function(...i){if(!R(s,e))throw new Error(`Permission denied: ${e} ${s}`);return t.apply(this,i)}}}function Gn(s,e){return function(t,i,n){const r=n.value;return n.value=function(...o){if(!R(s,e))throw new Error(`Permission denied: ${e} ${s}`);return r.apply(this,o)},n}}function Jn(){return _.ability}function Wn(s,e=[]){_.update(s,e)}function Fs(){_.clear()}function Yn(s){const e={};return Object.entries(s).forEach(([t,[i,n]])=>{e[t]=R(i,n)}),e}function Kn(s,e=null){const t=Y(s);return!t&&e&&e("/access-denied"),t}class qs{constructor(){this._listeners=new Set}can(e,t,i){const n=()=>R(e,t);return i&&(this._listeners.add(i),i(n())),n()}notifyChange(){this._listeners.forEach(e=>e())}clear(){this._listeners.clear()}}const Xn=new qs;function Hs(){const s=x();if(!s)return{};const t=JSON.parse(localStorage.getItem("users_cache")||"[]").find(r=>r.id===s.id);if(!t||!t.assignedRoles)return{};const i=JSON.parse(localStorage.getItem("roles_cache")||"[]"),n={};return t.assignedRoles.forEach(r=>{const o=i.find(a=>a.id===r);o&&o.permissions&&Object.keys(o.permissions).forEach(a=>{n[a]||(n[a]=[]),o.permissions[a].forEach(c=>{n[a].includes(c)||n[a].push(c)})})}),n}async function Zn(s,e){try{s&&e&&(localStorage.setItem("users_cache",JSON.stringify(s)),localStorage.setItem("roles_cache",JSON.stringify(e)))}catch(t){console.error("Failed to initialize permission cache:",t)}}const Fe=Object.freeze(Object.defineProperty({__proto__:null,Actions:m,PermissionChecker:qs,RequirePermission:Gn,Subjects:d,canAccessRoute:Y,checkPermissions:Yn,clearAbilities:Fs,entities:Ls,getAbility:Jn,getUserPermissions:Hs,getUserPermissionsSummary:Bs,guardRoute:Kn,hasAllPermissions:js,hasAnyPermission:Ds,hasPermission:R,initializeAbilities:lt,initializePermissionCache:Zn,isAdmin:zs,permissionChecker:Xn,permissionTypes:Fn,requirePermission:Vn,updateAbilities:Wn},Symbol.toStringTag,{value:"Module"})),Vs="current_module";function j(){const s=x();if(!s)return[];const t=JSON.parse(localStorage.getItem("users_cache")||"[]").find(l=>l.id===s.id);if(!t)return[];const i=t.assignedRoles||[];if(i.length===0)return[];const n=JSON.parse(localStorage.getItem("roles_cache")||"[]"),r={};i.forEach(l=>{const p=n.find(u=>u.id===l);p&&p.permissions&&Object.assign(r,p.permissions)});const o=new Set;o.add("core");const a={users:"admin",roles:"admin",permissions:"admin",audit:"admin",security:"admin",sessions:"admin",incidents:"sla",orders:"sales",products:"sales",customers:"commerce",customer_orgs:"commerce",companies:"companies",quotes:"commerce",purchase_orders:"commerce",reports:"analytics",analytics:"analytics",gdocs:"gdocs",commerce:"commerce",inventory:"commerce"};Object.keys(r).forEach(l=>{const p=a[l];p&&o.add(p)});const c=Be.filter(l=>o.has(l.id));return console.log("🧭 getUserModules accessibleModuleIds:",Array.from(o)),console.log("🧭 getUserModules result:",c.map(l=>l.id)),c}function Nt(){const s=localStorage.getItem(Vs);return s?j().find(i=>i.id===s)||Be.find(i=>i.id==="core"):Be.find(i=>i.id==="core")}function Qn(s){return j().find(i=>i.id===s)?(localStorage.setItem(Vs,s),!0):!1}function Gs(s){return j().some(t=>t.id===s)}function er(){const s=x();if(!s)return!1;const e=JSON.parse(localStorage.getItem("users_cache")||"[]"),t=JSON.parse(localStorage.getItem("roles_cache")||"[]"),i=e.find(n=>n.id===s.id);return!i||!i.assignedRoles?!1:i.assignedRoles.some(n=>{const r=t.find(o=>o.id===n);return r&&(r.category==="system"||r.name.includes("Super Admin"))})}function xo(){return j()}let S=[],tr=5;async function K(){return S.length===0&&(S=await pe("/roles.json")),S}async function ve(){const s=await K();return localStorage.setItem("roles_cache",JSON.stringify(s)),[...s]}async function sr(s){return(await K()).find(t=>t.id===s)||null}async function ir(s){await K();const e={id:tr++,name:s.name,description:s.description||"",permissions:s.permissions||[],userCount:0};return S.push(e),localStorage.setItem("roles_cache",JSON.stringify(S)),e}async function nr(s,e){await K();const t=S.findIndex(i=>i.id===s);return t!==-1?(S[t]={...S[t],...e,id:s},localStorage.setItem("roles_cache",JSON.stringify(S)),S[t]):null}async function rr(s){await K();const e=S.findIndex(t=>t.id===s);return e!==-1?(S.splice(e,1),localStorage.setItem("roles_cache",JSON.stringify(S)),!0):!1}const Js=Object.freeze(Object.defineProperty({__proto__:null,createRole:ir,deleteRole:rr,getRoleById:sr,getRoles:ve,updateRole:nr},Symbol.toStringTag,{value:"Module"}));let $=[],or=7;async function z(){return $.length===0&&($=await pe("/users.json")),$}async function ar(){const s=await z();return localStorage.setItem("users_cache",JSON.stringify(s)),[...s]}async function Ws(s){return(await z()).find(t=>t.id===s)||null}async function cr(s){await z();const e={id:or++,name:s.name,email:s.email,username:s.username||"",role:s.role||"User",status:s.status||"Active",active:(s.status||"Active")==="Active",organizationId:s.organizationId||"",departmentId:s.departmentId||"",teamId:s.teamId||"",permissionScope:s.permissionScope||"own",mfaEnabled:!!s.mfaEnabled,accountLocked:!!s.accountLocked,passwordExpires:s.passwordExpires!==!1,sessionTimeout:s.sessionTimeout||60,assignedRoles:s.assignedRoles||[]};return $.push(e),localStorage.setItem("users_cache",JSON.stringify($)),e}async function lr(s,e){await z();const t=$.findIndex(i=>i.id===s);return t!==-1?($[t]={...$[t],...e,id:s},localStorage.setItem("users_cache",JSON.stringify($)),$[t]):null}async function dr(s,e){await z();const t=$.find(i=>i.id===s);return t?(t.assignedRoles=e,localStorage.setItem("users_cache",JSON.stringify($)),t):null}async function ur(s){await z();const e=$.findIndex(t=>t.id===s);return e!==-1?($.splice(e,1),localStorage.setItem("users_cache",JSON.stringify($)),!0):!1}const Ys=Object.freeze(Object.defineProperty({__proto__:null,assignRolesToUser:dr,createUser:cr,deleteUser:ur,getUserById:Ws,getUsers:ar,updateUser:lr},Symbol.toStringTag,{value:"Module"}));class hr{constructor(){this._authenticated=!1,this._user=null,this._lastCheck=0,this._checkInterval=1e3,this._listeners=new Set,this._updateState(),window.addEventListener("user-logged-in",()=>this._updateState()),window.addEventListener("user-logged-out",()=>this._updateState()),window.addEventListener("oidc-token-expired",()=>this._updateState())}get authenticated(){return this._checkCache(),this._authenticated}get user(){return this._checkCache(),this._user}canAccess(e){return this._checkCache(),this._authenticated?Y(e,this._user):!1}refresh(){this._updateState()}subscribe(e){return this._listeners.add(e),()=>this._listeners.delete(e)}_checkCache(){Date.now()-this._lastCheck>this._checkInterval&&this._updateState()}_updateState(){const e=this._authenticated,t=this._user;this._authenticated=me(),this._user=this._authenticated?x():null,this._lastCheck=Date.now(),(e!==this._authenticated||t!==this._user)&&this._notifyListeners()}_notifyListeners(){this._listeners.forEach(e=>{try{e({authenticated:this._authenticated,user:this._user})}catch(t){console.error("Error in auth state listener:",t)}})}}const w=new hr,pr=Object.freeze(Object.defineProperty({__proto__:null,authState:w,default:w},Symbol.toStringTag,{value:"Module"}));class mr{constructor(e,t=null){this.key=e,this._value=t,this._listeners=new Set}get value(){return this._value}set value(e){this._value!==e&&(this._value=e,this._notifyListeners())}subscribe(e){return this._listeners.add(e),()=>this._listeners.delete(e)}_notifyListeners(){this._listeners.forEach(e=>e(this._value))}}function dt(s,e=null){return new mr(s,e)}const Ro=s=>class extends s{constructor(){super(),this._contextSubscriptions=new Map}consumeContext(e,t){this._contextSubscriptions.has(e)&&this._contextSubscriptions.get(e)();const i=e.subscribe(n=>{t&&t(n),this.requestUpdate()});return this._contextSubscriptions.set(e,i),e.value}disconnectedCallback(){super.disconnectedCallback?.(),this._contextSubscriptions.forEach(e=>e()),this._contextSubscriptions.clear()}},Ks=dt("user-context",{user:null,isAuthenticated:!1,isLoading:!1,error:null});class fr{constructor(){this._context=Ks,this._updateContext()}get context(){return this._context}_updateContext(){try{const e=x(),t=me();this._context.value={user:e,isAuthenticated:t,isLoading:!1,error:null}}catch(e){this._context.value={user:null,isAuthenticated:!1,isLoading:!1,error:e.message}}}setUser(e){this._context.value={...this._context.value,user:e,isAuthenticated:!!e,error:null}}clearUser(){this._context.value={user:null,isAuthenticated:!1,isLoading:!1,error:null}}setLoading(e){this._context.value={...this._context.value,isLoading:e}}setError(e){this._context.value={...this._context.value,error:e?.message||e,isLoading:!1}}async refresh(){this.setLoading(!0);try{this._updateContext()}catch(e){this.setError(e)}}}const qe=new fr,Xs=dt("permission-context",{ability:null,isInitialized:!1,summary:null});class gr{constructor(){this._context=Xs,this._updateContext()}get context(){return this._context}_updateContext(){this._context.value={ability:_.ability,isInitialized:!!_.ability,summary:_.ability?Bs():null}}async initialize(e,t=[]){try{_.init(e,t),this._updateContext()}catch(i){console.error("Failed to initialize permissions:",i)}}update(e,t=[]){_.update(e,t),this._updateContext()}clear(){_.clear(),this._context.value={ability:null,isInitialized:!1,summary:null}}refresh(){this._updateContext()}can(e,t,i=null){return R(e,t,i)}canAny(e,t){return Ds(e,t)}canAll(e,t){return js(e,t)}canAccessRoute(e){return Y(e)}isAdmin(){return zs()}}const He=new gr,Zs=dt("app-context",{theme:"light",sidebarCollapsed:!1,notifications:[],loading:!1,currentModule:null,breadcrumbs:[],pageTitle:"",metadata:{}});class br{constructor(){this._context=Zs,this._loadPersistedState()}get context(){return this._context}_loadPersistedState(){try{const e=localStorage.getItem("app-theme"),t=localStorage.getItem("sidebar-collapsed");this._context.value={...this._context.value,theme:e||"light",sidebarCollapsed:t==="true"}}catch(e){console.error("Failed to load persisted app state:",e)}}setTheme(e){this._context.value={...this._context.value,theme:e},localStorage.setItem("app-theme",e)}toggleTheme(){const e=this._context.value.theme==="light"?"dark":"light";this.setTheme(e)}setSidebarCollapsed(e){this._context.value={...this._context.value,sidebarCollapsed:e},localStorage.setItem("sidebar-collapsed",e.toString())}toggleSidebar(){this.setSidebarCollapsed(!this._context.value.sidebarCollapsed)}addNotification(e){const t=[...this._context.value.notifications];t.push({id:Date.now(),timestamp:new Date,...e}),this._context.value={...this._context.value,notifications:t}}removeNotification(e){const t=this._context.value.notifications.filter(i=>i.id!==e);this._context.value={...this._context.value,notifications:t}}clearNotifications(){this._context.value={...this._context.value,notifications:[]}}setLoading(e){this._context.value={...this._context.value,loading:e}}setCurrentModule(e){this._context.value={...this._context.value,currentModule:e}}setBreadcrumbs(e){this._context.value={...this._context.value,breadcrumbs:e}}setPageTitle(e){this._context.value={...this._context.value,pageTitle:e},document.title=e}setMetadata(e){this._context.value={...this._context.value,metadata:{...this._context.value.metadata,...e}}}reset(){this._context.value={theme:"light",sidebarCollapsed:!1,notifications:[],loading:!1,currentModule:null,breadcrumbs:[],pageTitle:"",metadata:{}}}}const Ve=new br,Co=Ks,Oo=Xs,Io=Zs;function _r(){return{user:qe.context,permission:He.context,app:Ve.context}}const C={GLOBAL:"global",ORGANIZATION:"organization",DEPARTMENT:"department",TEAM:"team",OWN:"own",CUSTOM:"custom"};function yr(s){return _.can(s,"Application")}function vr(s,e){return yr("manage")?!0:_.can(e,`Module:${s}`)}function ut(s,e,t=null){return _.can(e,s,t)}function wr(s,e,t,i=null){if(!ut(s,t,i))return!1;const n=ht();if(!n)return!1;const r=Sr(n,s);if(r&&r[e]){const o=r[e];if(t==="read")return o.readable!==!1;if(t==="write"||t==="update")return o.writable!==!1}return!0}function Qs(s,e,t,i=C.GLOBAL){const n=ht();if(!n||!ut(s,e))return!1;switch(i){case C.GLOBAL:return!0;case C.ORGANIZATION:return t.organizationId===n.organizationId;case C.DEPARTMENT:return t.departmentId===n.departmentId;case C.TEAM:return t.teamId===n.teamId;case C.OWN:return t.ownerId===n.id||t.createdBy===n.id||t.assignedTo===n.id;case C.CUSTOM:return $r(s,t,n);default:return!1}}function Er(s,e,t){return ht()?s.filter(n=>Qs(e,"read",n,t)):[]}function $r(s,e,t){const i=xr(t,s);return!i||i.length===0?!1:i.every(n=>Ar(e,n.condition,t))}function Ar(s,e,t){const{field:i,operator:n,value:r}=e,o=s[i];switch(n){case"equals":return o===r;case"notEquals":return o!==r;case"in":return Array.isArray(r)&&r.includes(o);case"notIn":return Array.isArray(r)&&!r.includes(o);case"contains":return String(o).includes(r);case"startsWith":return String(o).startsWith(r);case"endsWith":return String(o).endsWith(r);case"greaterThan":return o>r;case"lessThan":return o<r;case"isCurrentUser":return o===t.id;case"isInUserTeam":return t.teamMembers&&t.teamMembers.includes(o);default:return!1}}function Sr(s,e){const i=JSON.parse(localStorage.getItem("roles_cache")||"[]").filter(r=>s.assignedRoles?.includes(r.id)),n={};return i.forEach(r=>{r.fieldPermissions&&r.fieldPermissions[e]&&Object.assign(n,r.fieldPermissions[e])}),n}function xr(s,e){const i=JSON.parse(localStorage.getItem("roles_cache")||"[]").filter(r=>s.assignedRoles?.includes(r.id)),n=[];return i.forEach(r=>{r.scopeRules&&r.scopeRules[e]&&n.push(...r.scopeRules[e])}),n}function ht(){try{const s=localStorage.getItem("currentUser");return s?JSON.parse(s):null}catch(s){return console.error("Failed to get current user:",s),null}}class Rr{constructor(){this._user=null,this._roles=[],this._permissions={},this._initialized=!1,this._auditLog=[]}async initialize(e=null,t=[]){e||(e=x()),this._user=e,this._roles=t,this._initialized=!0,_.init(e,t),this._buildPermissionCache(),this._logAudit("SECURITY_CONTEXT_INITIALIZED",{userId:e?.id,roleIds:t.map(i=>i.id)})}_buildPermissionCache(){this._user&&(this._permissions={app:{},modules:{},entities:{}},this._roles.forEach(e=>{e.moduleAccess&&Object.entries(e.moduleAccess).forEach(([t,i])=>{this._permissions.modules[t]=i}),e.permissions&&Object.entries(e.permissions).forEach(([t,i])=>{this._permissions.entities[t]||(this._permissions.entities[t]=new Set),i.forEach(n=>this._permissions.entities[t].add(n))})}))}isAuthenticated(){return this._initialized&&this._user!==null}getUser(){return this._user}getRoles(){return this._roles}getSecurityContext(){return this._user?{userId:this._user.id,username:this._user.username,roles:this._roles.map(e=>e.id),roleNames:this._roles.map(e=>e.name),scope:this._user.permissionScope||C.OWN,organizationId:this._user.organizationId,departmentId:this._user.departmentId,teamId:this._user.teamId,attributes:this._user.attributes||{},mfaEnabled:this._user.mfaEnabled||!1}:null}can(e,t,i=null){this._ensureInitialized();const n=_.can(e,t,i);return n&&this._logAudit("PERMISSION_GRANTED",{action:e,subject:t,conditions:i}),n}cannot(e,t,i=null){return!this.can(e,t,i)}canAccessModule(e){return this._ensureInitialized(),vr(e,"read")}canAccessEntity(e,t){return this._ensureInitialized(),ut(e,t)}canAccessField(e,t,i){return this._ensureInitialized(),wr(e,t,i)}canAccessRecord(e,t,i){this._ensureInitialized();const n=this._user?.permissionScope||C.OWN;return Qs(e,t,i,n)}filterRecords(e,t){this._ensureInitialized();const i=this._user?.permissionScope||C.OWN;return Er(e,t,i)}isAdmin(){return this._ensureInitialized(),_.isAdmin()}hasRole(e){return this._ensureInitialized(),this._roles.some(t=>t.name===e)}hasAnyRole(e){return this._ensureInitialized(),e.some(t=>this.hasRole(t))}hasAllRoles(e){return this._ensureInitialized(),e.every(t=>this.hasRole(t))}getPermissionSummary(){return this._ensureInitialized(),_.getPermissionsSummary()}requiresMfa(e,t){this._ensureInitialized();const i=["delete","manage"],n=["User","Role","Permission","Settings"];return i.includes(e)||n.includes(t)}async validateMfa(e,t){if(!this.requiresMfa(e,t))return!0;if(!this._user?.mfaEnabled)throw new Error("MFA is required for this action but not enabled for user");return!0}_logAudit(e,t={}){const i={timestamp:new Date().toISOString(),event:e,userId:this._user?.id,username:this._user?.username,details:t,ip:this._user?.lastLoginIp||"unknown"};this._auditLog.push(i),this._auditLog.length>1e3&&this._auditLog.shift(),this._sendToAuditService(i)}_sendToAuditService(e){console.log("[AUDIT]",e)}getAuditLog(e=100){return this._auditLog.slice(-e)}_ensureInitialized(){if(!this._initialized)throw new Error("Security context not initialized. Call initialize() first.")}clear(){this._logAudit("SECURITY_CONTEXT_CLEARED",{userId:this._user?.id}),this._user=null,this._roles=[],this._permissions={},this._initialized=!1,_.clear()}async refresh(){this._user&&await this.initialize(this._user)}}const re=new Rr;async function Cr(){try{console.log("[Security Init] Starting security initialization...");const s=x();if(!s)return console.warn("[Security Init] No authenticated user found"),!1;console.log("[Security Init] Current user:",s.name);const e=await ve();console.log("[Security Init] Loaded roles:",e.length);const t=await Ws(s.id);if(!t)return console.error("[Security Init] User profile not found"),!1;const i=t.assignedRoles||[],n=e.filter(r=>i.includes(r.id));return console.log("[Security Init] User roles:",n.map(r=>r.name)),await re.initialize(t,n),console.log("[Security Init] ✓ Security context initialized successfully"),console.log("[Security Init] User scope:",t.permissionScope),console.log("[Security Init] Is Admin:",re.isAdmin()),Ir(t,n),!0}catch(s){return console.error("[Security Init] Failed to initialize security:",s),!1}}function Or(){console.log("[Security Init] Clearing security context..."),re.clear(),Pr(),console.log("[Security Init] ✓ Security context cleared")}function Ir(s,e){try{const t={userId:s.id,userName:s.name,userEmail:s.email,roles:e.map(i=>({id:i.id,name:i.name,priority:i.priority})),scope:s.permissionScope,organizationId:s.organizationId,departmentId:s.departmentId,teamId:s.teamId,isAdmin:re.isAdmin(),cachedAt:new Date().toISOString()};localStorage.setItem("security_info",JSON.stringify(t))}catch(t){console.error("[Security Init] Failed to cache security info:",t)}}function Pr(){try{localStorage.removeItem("security_info")}catch(s){console.error("[Security Init] Failed to clear security cache:",s)}}class H{constructor(){if(H.instance)return H.instance;this.routeLoaders=new Map,this.loadedRoutes=new Map,H.instance=this}register(e,t){this.routeLoaders.set(e,t)}async get(e){if(this.loadedRoutes.has(e))return this.loadedRoutes.get(e);const t=this.routeLoaders.get(e);if(!t)return console.warn(`RouterProvider: No loader registered for "${e}"`),[];try{const i=await t();return this.loadedRoutes.set(e,i),i}catch(i){return console.error(`RouterProvider: Failed to load routes for "${e}"`,i),[]}}async getMultiple(e){return(await Promise.all(e.map(i=>this.get(i)))).flat()}async getAll(){const e=Array.from(this.routeLoaders.keys());return this.getMultiple(e)}clearCache(){this.loadedRoutes.clear()}unregister(e){this.routeLoaders.delete(e),this.loadedRoutes.delete(e)}}const ei=new H;function kr(s){Object.entries(s).forEach(([e,t])=>{ei.register(e,t)})}kr({public:async()=>{const{publicRoutes:s}=await g(async()=>{const{publicRoutes:e}=await import("./public.routes-Chnlz8El.js");return{publicRoutes:e}},[]);return s},protected:async()=>{const{protectedRoutes:s}=await g(async()=>{const{protectedRoutes:e}=await import("./protected.routes-COpfTkmV.js");return{protectedRoutes:e}},[]);return s},admin:async()=>{const{createAdminRoutes:s}=await g(async()=>{const{createAdminRoutes:e}=await import("./admin.router-DPO0dbEG.js");return{createAdminRoutes:e}},[]);return s()},sla:async()=>{const{createSLARoutes:s}=await g(async()=>{const{createSLARoutes:e}=await import("./sla.router-D4-ApwE1.js");return{createSLARoutes:e}},[]);return s()},sales:async()=>{const{createSalesRoutes:s}=await g(async()=>{const{createSalesRoutes:e}=await import("./sales.router-Bx0nwwsX.js");return{createSalesRoutes:e}},[]);return s()},analytics:async()=>{const{createAnalyticsRoutes:s}=await g(async()=>{const{createAnalyticsRoutes:e}=await import("./analytics.router-TGTHgwYG.js");return{createAnalyticsRoutes:e}},[]);return s()},commerce:async()=>{const{createCommerceRoutes:s}=await g(async()=>{const{createCommerceRoutes:e}=await import("./commerce.router-DnrQx7AF.js");return{createCommerceRoutes:e}},[]);return s()},b2bManagement:async()=>{const{createB2BManagementRoutes:s}=await g(async()=>{const{createB2BManagementRoutes:e}=await import("./b2b-management.router-B46Jm2tx.js");return{createB2BManagementRoutes:e}},[]);return s()},b2bStorefront:async()=>{const{createB2BStorefrontRoutes:s}=await g(async()=>{const{createB2BStorefrontRoutes:e}=await import("./b2b-storefront.router-CgWEE44g.js");return{createB2BStorefrontRoutes:e}},[]);return s()},gdocs:async()=>{const{createGDocsRoutes:s}=await g(async()=>{const{createGDocsRoutes:e}=await import("./gdocs.router-D3eOHVTj.js");return{createGDocsRoutes:e}},[]);return s()},fallback:async()=>{const{html:s}=await g(async()=>{const{html:e}=await Promise.resolve().then(()=>wi);return{html:e}},void 0);return[{path:"/*",render:()=>s`<not-found></not-found>`}]}});class V{constructor(){if(V.instance)return V.instance;this.services=new Map,this.singletons=new Map,this.factories=new Map,V.instance=this}singleton(e,t){this.services.set(e,{type:"singleton",value:t})}factory(e,t){this.services.set(e,{type:"factory",value:t})}lazy(e,t){this.services.set(e,{type:"lazy",value:t})}async get(e){const t=this.services.get(e);if(!t)throw new Error(`ServiceProvider: Service "${e}" not registered`);switch(t.type){case"singleton":return this._resolveSingleton(e,t);case"factory":return t.value();case"lazy":return this._resolveLazy(e,t);default:throw new Error(`ServiceProvider: Unknown service type "${t.type}"`)}}async _resolveSingleton(e,t){if(this.singletons.has(e))return this.singletons.get(e);const i=typeof t.value=="function"?new t.value:t.value;return this.singletons.set(e,i),i}async _resolveLazy(e,t){if(this.singletons.has(e))return this.singletons.get(e);const i=await t.value(),n=i.default||i;return this.singletons.set(e,n),n}has(e){return this.services.has(e)}remove(e){this.services.delete(e),this.singletons.delete(e)}clear(){this.services.clear(),this.singletons.clear()}getRegistered(){return Array.from(this.services.keys())}}const Oe=new V;function Mr(s){Object.entries(s).forEach(([e,t])=>{t.type==="singleton"?Oe.singleton(e,t.value):t.type==="factory"?Oe.factory(e,t.value):t.type==="lazy"&&Oe.lazy(e,t.value)})}Mr({authState:{type:"singleton",value:()=>g(()=>Promise.resolve().then(()=>pr),void 0).then(s=>s.authState)},dataService:{type:"lazy",value:()=>g(()=>import("./dataService-CD0XMSGL.js"),__vite__mapDeps([0,1,2,3,4,5,6,7]))},apiService:{type:"lazy",value:()=>g(()=>Promise.resolve().then(()=>ki),void 0)},abilityService:{type:"singleton",value:()=>g(()=>Promise.resolve().then(()=>Bn),void 0).then(s=>s.abilityService)},caslPermissionService:{type:"lazy",value:()=>g(()=>Promise.resolve().then(()=>Fe),void 0)},cartService:{type:"lazy",value:()=>g(()=>import("./cart.service-B_SpTUv2.js"),__vite__mapDeps([8,9,10]))},orderService:{type:"lazy",value:()=>g(()=>import("./order.service-Bg4usqe-.js"),[])},productService:{type:"lazy",value:()=>g(()=>import("./product.service-iC3Sx6BM.js"),__vite__mapDeps([9,10]))},companyService:{type:"lazy",value:()=>g(()=>import("./company.service-D2dl1Zj8.js"),__vite__mapDeps([1,2]))},quoteService:{type:"lazy",value:()=>g(()=>import("./quote.service-BGOQ22DU.js"),__vite__mapDeps([11,12]))},contractService:{type:"lazy",value:()=>g(()=>import("./contract.service-DR3D3qAM.js"),__vite__mapDeps([13,14]))},pricelistService:{type:"lazy",value:()=>g(()=>import("./pricelist.service-Bwtdc_5B.js"),__vite__mapDeps([15,16]))},purchaseOrderService:{type:"lazy",value:()=>g(()=>import("./purchaseorder.service-yBdPWREO.js"),[])},incidentService:{type:"lazy",value:()=>g(()=>import("./incident.service-B79K0bK8.js"),[])},gdocsService:{type:"lazy",value:()=>g(()=>import("./gdocs.service-CaVGXYUm.js"),[])},inboxService:{type:"lazy",value:()=>g(()=>import("./inbox.service-CSnYiWam.js"),__vite__mapDeps([6,1,2]))},outboxService:{type:"lazy",value:()=>g(()=>import("./outbox.service-Db8Bhfap.js"),[])},analyticsService:{type:"lazy",value:()=>g(()=>import("./analytics.service-24UmsJYf.js"),[])},userService:{type:"lazy",value:()=>g(()=>Promise.resolve().then(()=>Ys),void 0)},roleService:{type:"lazy",value:()=>g(()=>Promise.resolve().then(()=>Js),void 0)},permissionService:{type:"lazy",value:()=>g(()=>Promise.resolve().then(()=>Fe),void 0)}});class Tr extends E{static properties={username:{type:String},password:{type:String},loading:{type:Boolean},error:{type:String},showPassword:{type:Boolean}};createRenderRoot(){return this}constructor(){super(),this.username="",this.password="",this.loading=!1,this.error="",this.showPassword=!1}async _handleSubmit(e){e.preventDefault(),this.error="",this.loading=!0;try{await Bi(this.username,this.password),window.location.href="/"}catch(t){this.error=t.message||"Login failed"}finally{this.loading=!1}}_togglePasswordVisibility(){this.showPassword=!this.showPassword}render(){return h`
    ...
    `}}customElements.define("login-page",Tr);class Ur extends E{static properties={loading:{type:Boolean},error:{type:String}};createRenderRoot(){return this}constructor(){super(),this.loading=!0,this.error=null}connectedCallback(){super.connectedCallback(),this._handleCallback()}async _handleCallback(){try{const e=await Ni(),t=Li(e);localStorage.setItem("auth_user",JSON.stringify(t)),localStorage.setItem("auth_token",e.access_token),window.location.href="/"}catch(e){console.error("OIDC callback error:",e),this.error=e.message||"Authentication failed",this.loading=!1}}render(){return this.loading?h`
      ...
      `:h``}}customElements.define("oidc-callback",Ur);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const I={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},we=s=>(...e)=>({_$litDirective$:s,values:e});class Ee{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{I:Nr}=Yt,Lr=s=>s.strings===void 0,Lt=()=>document.createComment(""),F=(s,e,t)=>{const i=s._$AA.parentNode,n=e===void 0?s._$AB:e._$AA;if(t===void 0){const r=i.insertBefore(Lt(),n),o=i.insertBefore(Lt(),n);t=new Nr(r,o,s,s.options)}else{const r=t._$AB.nextSibling,o=t._$AM,a=o!==s;if(a){let c;t._$AQ?.(s),t._$AM=s,t._$AP!==void 0&&(c=s._$AU)!==o._$AU&&t._$AP(c)}if(r!==n||a){let c=t._$AA;for(;c!==r;){const l=c.nextSibling;i.insertBefore(c,n),c=l}}}return t},M=(s,e,t=s)=>(s._$AI(e,t),s),Dr={},ti=(s,e=Dr)=>s._$AH=e,jr=s=>s._$AH,Ie=s=>{s._$AR(),s._$AA.remove()};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Dt=(s,e,t)=>{const i=new Map;for(let n=e;n<=t;n++)i.set(s[n],n);return i},zr=we(class extends Ee{constructor(s){if(super(s),s.type!==I.CHILD)throw Error("repeat() can only be used in text expressions")}dt(s,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const n=[],r=[];let o=0;for(const a of s)n[o]=i?i(a,o):o,r[o]=t(a,o),o++;return{values:r,keys:n}}render(s,e,t){return this.dt(s,e,t).values}update(s,[e,t,i]){const n=jr(s),{values:r,keys:o}=this.dt(e,t,i);if(!Array.isArray(n))return this.ut=o,r;const a=this.ut??=[],c=[];let l,p,u=0,b=n.length-1,f=0,v=r.length-1;for(;u<=b&&f<=v;)if(n[u]===null)u++;else if(n[b]===null)b--;else if(a[u]===o[f])c[f]=M(n[u],r[f]),u++,f++;else if(a[b]===o[v])c[v]=M(n[b],r[v]),b--,v--;else if(a[u]===o[v])c[v]=M(n[u],r[v]),F(s,c[v+1],n[u]),u++,v--;else if(a[b]===o[f])c[f]=M(n[b],r[f]),F(s,n[u],n[b]),b--,f++;else if(l===void 0&&(l=Dt(o,f,v),p=Dt(a,u,b)),l.has(a[u]))if(l.has(a[b])){const O=p.get(o[f]),$e=O!==void 0?n[O]:null;if($e===null){const pt=F(s,n[u]);M(pt,r[f]),c[f]=pt}else c[f]=M($e,r[f]),F(s,n[u],$e),n[O]=null;f++}else Ie(n[b]),b--;else Ie(n[u]),u++;for(;f<=v;){const O=F(s,c[v+1]);M(O,r[f]),c[f++]=O}for(;u<=b;){const O=n[u++];O!==null&&Ie(O)}return this.ut=o,ti(s,c),A}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Br=we(class extends Ee{constructor(s){if(super(s),s.type!==I.ATTRIBUTE||s.name!=="class"||s.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(s){return" "+Object.keys(s).filter(e=>s[e]).join(" ")+" "}update(s,[e]){if(this.st===void 0){this.st=new Set,s.strings!==void 0&&(this.nt=new Set(s.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in e)e[i]&&!this.nt?.has(i)&&this.st.add(i);return this.render(e)}const t=s.element.classList;for(const i of this.st)i in e||(t.remove(i),this.st.delete(i));for(const i in e){const n=!!e[i];n===this.st.has(i)||this.nt?.has(i)||(n?(t.add(i),this.st.add(i)):(t.remove(i),this.st.delete(i)))}return A}});/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Fr=we(class extends Ee{constructor(s){if(super(s),s.type!==I.PROPERTY&&s.type!==I.ATTRIBUTE&&s.type!==I.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Lr(s))throw Error("`live` bindings can only contain a single expression")}render(s){return s}update(s,[e]){if(e===A||e===y)return e;const t=s.element,i=s.name;if(s.type===I.PROPERTY){if(e===t[i])return A}else if(s.type===I.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return A}else if(s.type===I.ATTRIBUTE&&t.getAttribute(i)===e+"")return A;return ti(s),e}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function qr(s,e,t){return s?e(s):t?.(s)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class oe extends Ee{constructor(e){if(super(e),this.it=y,e.type!==I.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===y||e==null)return this._t=void 0,this.it=e;if(e===A)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}}oe.directiveName="unsafeHTML",oe.resultType=1;const Hr=we(oe);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class jt extends oe{}jt.directiveName="unsafeSVG",jt.resultType=2;const Po=zr,ko=Br,Mo=Fr,To=qr,Vr=Hr;class Gr extends E{static properties={title:{type:String,reflect:!0},highlight:{type:Boolean,reflect:!0},items:{type:String,reflect:!0},autoincrement:{type:Boolean,reflect:!0}};createRenderRoot(){return this}constructor(){super(),this.data=null,this.allRoles=[]}connectedCallback(){super.connectedCallback(),this._load()}async _load(){this.data=await qn(),this.allRoles=await ve(),this._applyPropsToData(),this.requestUpdate()}_applyPropsToData(){if(this.data&&(this.title&&(this.data.title=this.title),this.highlight!==void 0&&(this.data.highlight=this.highlight),this.items))try{this.data.items=JSON.parse(this.items)}catch(e){console.error("Invalid items JSON:",e)}}render(){const e=x(),t=Hs(),i=Object.values(t).reduce((l,p)=>l+p.length,0),n=j(),r=er(),o=(e?.assignedRoles||[]).map(l=>this.allRoles.find(p=>p.id===l)?.name).filter(l=>l),c={global:"Global Access",organization:"Organization",own:"Own Data Only"}[e?.permissionScope]||e?.permissionScope||"Not Set";return h`
      <div>
        <!-- Welcome Banner -->
    ...
    `}}customElements.define("home-page",Gr);class Jr extends E{static properties={xml:{type:String},error:{type:String},mode:{type:String}};static styles=Bt`
...
`,r+=a}),n.trim()}_escape(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\"/g,"&quot;").replace(/\'/g,"&#39;")}_highlight(e){let t=e;return t=t.replace(/(&lt;\/?)([\w:-]+)([^&]*?)(&gt;)/g,(i,n,r,o,a)=>{const c=o.replace(/([\w:-]+)(=)(&quot;.*?&quot;)/g,'<span class="attr">$1</span>$2<span class="value">$3</span>');return`<span class="tag">${n}</span><span class="name">${r}</span>${c}<span class="tag">${a}</span>`}).replace(/(^|\n)([^<\n][^\n]*)/g,(i,n,r)=>`${n}<span class="text">${r}</span>`),t}_onSample(){this.xml=`<order id="PO-1001">
  ...
  <items>
    ...
    `}_renderMode(){if(this.mode==="table"){const e=this._toJson(this.xml),t=this._asCollection(e);return this._renderTable(t)}if(this.mode==="cards"){const e=this._toJson(this.xml),t=this._asCollection(e);return this._renderCards(t)}if(this.mode==="blocks"){const e=this._toJson(this.xml),t=this._asCollection(e);return this._renderBlocks(t)}return h`<div class="viewer"><pre><code>${Vr(this._format(this.xml))}</code></pre></div>`}render(){return h`
      <h2>XML Viewer</h2>
      <div class="toolbar">
    ...
    `}}customElements.define("xml-viewer-page",Jr);class Wr extends E{createRenderRoot(){return this}_goBack(){window.history.back()}_goHome(){window.history.pushState({},"","/"),window.dispatchEvent(new PopStateEvent("popstate"))}render(){return h`
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-6 text-center">
            <div class="py-5">
    ...
    `}}customElements.define("access-denied",Wr);class Yr extends E{static properties={message:{type:String,reflect:!0}};createRenderRoot(){return this}render(){return h`
    ...
    `:h``}}customElements.define("impersonation-banner",io);class no extends E{static properties={currentUser:{type:Object},currentModule:{type:Object},userModules:{type:Array},menuOpen:{type:Boolean},menuPinned:{type:Boolean},expandedModules:{type:Object},menuFilter:{type:String}};createRenderRoot(){return this}constructor(){super(),this.currentUser=w.user,this.currentModule=Nt(),this.userModules=j(),this.menuOpen=!1,this.menuPinned=localStorage.getItem("menu_pinned")==="true",this.menuFilter="",this.menuPinned&&(this.menuOpen=!0),this.expandedModules=JSON.parse(localStorage.getItem("expanded_modules")||"{}"),this.currentModule&&!this.expandedModules.hasOwnProperty(this.currentModule.id)&&(this.expandedModules[this.currentModule.id]=!0),this.router=new xt(this,[]),this._routesReady=!1,this._routesPromise=this._initializeRoutes()}async _initializeRoutes(){try{const e=await ei.getMultiple(["public","protected","admin","customers","sla","sales","analytics","commerce","b2bManagement","b2bStorefront","gdocs","fallback"]);this.router=new xt(this,e),this._routesReady=!0,window.dispatchEvent(new PopStateEvent("popstate")),this.requestUpdate(),console.log("✅ Routes initialized, current path:",window.location.pathname)}catch(e){console.error("❌ Failed to initialize routes:",e),this._routesReady=!0}}async connectedCallback(){super.connectedCallback(),await this._routesPromise,console.log("✅ Routes ready"),this._initializeContexts(),console.log("✅ Contexts initialized"),await Hi(),this._checkAuth(),await this._initializePermissions(),this.addEventListener("click",this._handleClick.bind(this)),window.addEventListener("popstate",this._handlePopState.bind(this)),document.addEventListener("click",this._handleClickOutside.bind(this)),console.log("🚀 Triggering initial navigation for:",window.location.pathname),window.dispatchEvent(new PopStateEvent("popstate"))}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._handleClickOutside.bind(this))}_initializeContexts(){_r(),Ve.setCurrentModule(this.currentModule?.id||null)}_checkAuth(){const e=r=>r?r.endsWith("/")&&r!=="/"?r.replace(/\/+$/,""):r:"/",t=e(window.location.pathname),i=r=>{try{const o=typeof window.withBase=="function"?window.withBase(r):r;return new URL(o,window.location.origin).pathname}catch{return r}},n=[i("/login"),i("/callback"),i("/access-denied")].map(e);if(console.log("🔍 _checkAuth debug:",{rawPath:window.location.pathname,normalizedPath:t,publicPaths:n,isPublic:n.includes(t),authenticated:w.authenticated,BASE_URL:window.__BASE_URL}),n.includes(t)){console.log("✅ Public route detected, allowing access");return}if(!w.authenticated){const r=i("/login");console.log("❌ Not authenticated, checking redirect:",{currentPath:t,loginPath:e(r),shouldRedirect:e(t)!==e(r)}),e(t)!==e(r)?(console.log("🔄 Redirecting to:",r),window.location.href=r):console.log("⏸️ Already on login page, not redirecting");return}this.currentUser=w.user,qe.setUser(w.user)}async _initializePermissions(){if(!(!w.authenticated||!w.user))try{const e=await ve(),t=w.user.assignedRoles||[],i=e.filter(n=>t.includes(n.id));await lt(w.user,i),await Cr(),await He.initialize(w.user,i),console.log("✅ CASL permissions initialized for:",w.user.name),console.log("✅ Enterprise security context initialized")}catch(e){console.error("❌ Failed to initialize permissions:",e)}}_handleLogout(e){e.preventDefault(),Fi(),Fs(),Or(),qe.clearUser(),He.clear(),Ve.clearNotifications(),this.currentUser=null,window.location.href=window.withBase("/login")}_toggleMenu(){this.menuPinned||(this.menuOpen=!this.menuOpen)}_toggleMenuPin(){this.menuPinned=!this.menuPinned,localStorage.setItem("menu_pinned",this.menuPinned),this.menuPinned?this.menuOpen=!0:this.menuOpen=!1}_handleMenuMouseLeave(){}_handleMenuPinChanged(e){this.menuPinned=e.detail.pinned}_handleMenuClose(){this.menuOpen=!1}_handleMenuFilterChanged(e){if(this.menuFilter=e.detail.filter,this.menuFilter){const t={};this.userModules.forEach(i=>{this._moduleMatchesFilter(i)&&(t[i.id]=!0)}),this.expandedModules=t}}_handleMenuFilterCleared(){this.menuFilter=""}_handleModuleToggled(e){const t=e.detail.moduleId;this.expandedModules={...this.expandedModules,[t]:!this.expandedModules[t]},localStorage.setItem("expanded_modules",JSON.stringify(this.expandedModules))}_handleClickOutside(e){if(!this.menuPinned&&this.menuOpen){const t=this.querySelector(".top-menu-popover"),i=this.querySelector(".menu-toggle-btn");t&&!t.contains(e.target)&&!i.contains(e.target)&&(this.menuOpen=!1)}}_handleModuleSwitch(e){Qn(e)&&(this.currentModule=Nt(),window.history.pushState({},"",`/module/${e}`),window.dispatchEvent(new PopStateEvent("popstate")))}_toggleModuleExpansion(e,t){t.preventDefault(),t.stopPropagation(),this.expandedModules={...this.expandedModules,[e]:!this.expandedModules[e]},localStorage.setItem("expanded_modules",JSON.stringify(this.expandedModules))}_moduleMatchesFilter(e){if(!this.menuFilter)return!0;const t=this.menuFilter;return e.name.toLowerCase().includes(t)?!0:({admin:["dashboard","users","roles","permissions"],sla:["dashboard","incidents","tickets","agreements","metrics","reports","escalations","performance"],sales:["dashboard","orders","products","reports"],analytics:["dashboard","forecast"],gdocs:["inbox","outbox","reports","purchase orders","invoices","acknowledgements"],commerce:["dashboard","products","orders","cart","categories","discounts","inventory","companies","quotes","pricelists","contracts","purchase orders","storefront","catalog","quick order","account","punchout","external suppliers"],customers:["organizations","add organization"]}[e.id]||[]).some(r=>r.includes(t))}_menuItemMatchesFilter(e){return this.menuFilter?e.toLowerCase().includes(this.menuFilter):!0}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("click",this._handleClick),window.removeEventListener("popstate",this._handlePopState)}_toInternal(e){try{const t=window.__BASE_URL||"/";if(t!=="/"&&e.startsWith(t)){const i=e.substring(t.length-1);return console.log("🔧 _toInternal (stripped):",{path:e,base:t,stripped:i||"/"}),i||"/"}return console.log("🔧 _toInternal (passthrough):",{path:e,base:t}),e}catch(t){return console.error("❌ _toInternal error:",t),e}}_handlePopState(){const e=window.location.pathname+window.location.search+window.location.hash,t=this._toInternal(window.location.pathname)+window.location.search+window.location.hash;console.log("📡 _handlePopState:",{current:e,internal:t}),this.router&&typeof this.router.goto=="function"&&this.router.goto(t)}_handleClick(e){const t=e.target.closest("a");if(t&&t.getAttribute("href")?.startsWith("/")){e.preventDefault();const i=t.getAttribute("href"),n=this._toInternal(i);window.history.pushState({},"",i),this.router&&typeof this.router.goto=="function"&&this.router.goto(n),window.dispatchEvent(new PopStateEvent("popstate"))}}render(){const e=r=>r?r.endsWith("/")&&r!=="/"?r.replace(/\/+$/,""):r:"/",t=e(window.location.pathname),i=r=>{try{const o=typeof window.withBase=="function"?window.withBase(r):r;return new URL(o,window.location.origin).pathname}catch{return r}},n=[i("/login"),i("/callback"),i("/access-denied")].map(e).includes(t);return console.log("🎨 render() debug:",{rawPath:window.location.pathname,currentPath:t,isPublicRoute:n,authenticated:w.authenticated}),n?(console.log("✅ Rendering public route"),h`${this.router.outlet()}`):w.authenticated?h`
      <!-- Top Navigation -->
      <top-nav
    ...
    `:(console.log("⏸️ Not authenticated, waiting for _checkAuth redirect"),h``)}_isActive(e){return location.pathname===e?"active":""}}customElements.define("app-shell",no);export{ko as $,er as A,xo as B,ve as C,sr as D,ir as E,nr as F,rr as G,ar as H,Ws as I,cr as J,lr as K,dr as L,ur as M,h as N,w as O,Qt as P,pe as Q,Me as R,Te as S,E as T,ee as U,re as V,Bt as W,Mo as X,To as Y,Po as Z,g as _,Fi as a,Oe as a0,Co as a1,Oo as a2,Io as a3,Ro as a4,x as b,fo as c,go as d,bo as e,Hi as f,qi as g,Hs as h,me as i,R as j,Ds as k,Bi as l,js as m,Y as n,zs as o,Zn as p,Ao as q,Be as r,Ls as s,Fn as t,qn as u,So as v,j as w,Nt as x,Qn as y,Gs as z};
