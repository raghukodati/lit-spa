                          ...
                          <div class="btn-group btn-group-sm">
                            ${this.ifCan("contracts","update",e`
                              <button class="btn btn-outline-primary"
                                 @click=${()=>window.location.pathname=`/website/b2b/contracts/edit/${t.id}`}
                                 title="Edit Contract">
