import{T as r,N as e}from"./index-BTuak744.js";class n extends r{static properties={title:{type:String},subtitle:{type:String},variant:{type:String}};constructor(){super(),this.title="",this.subtitle="",this.variant=""}createRenderRoot(){return this}renderHeader(){const t=!!this.querySelector('[slot="header"]')||!!this.querySelector('[slot="actions"]');return!this.title&&!this.subtitle&&!t?null:e`
