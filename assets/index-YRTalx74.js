const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/dataService-o4kgJqMk.js","assets/company.service-DVWFSJX1.js","assets/company.model-CKmygYMs.js","assets/analytics.service-lxJDbI_y.js","assets/gdocs.service-BHTQ5WLz.js","assets/incident.service-XH5hsWvi.js","assets/inbox.service-40VxNeV0.js","assets/outbox.service-CvkZEt9Y.js","assets/cart.service-CvuaU-IL.js","assets/product.service-CxkNPT-C.js","assets/product.model-uhuUaOub.js","assets/quote.service-BXbfvMOW.js","assets/quote.model-CvL1ADQq.js","assets/contract.service-CKTMLsja.js","assets/contract.model-CkFP52sg.js","assets/pricelist.service-CnC-aq3e.js","assets/pricelist.model-B2sEL8yC.js"])))=>i.map(i=>d[i]);
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Xe=globalThis;let $=class extends T{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Kt(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return A}};$._$litElement$=!0,$.finalized=!0,Xe.litElementHydrateSupport?.({LitElement:$});const vi=Xe.litElementPolyfillSupport;vi?.({LitElement:$});(Xe.litElementVersions??=[]).push("4.2.1");const wi=Object.freeze(Object.defineProperty({__proto__:null,CSSResult:Je,LitElement:$,ReactiveElement:T,_$LH:Yt,adoptStyles:Ft,css:Bt,defaultConverter:te,getCompatibleStyle:Ue,html:h,noChange:A,notEqual:We,nothing:y,render:Kt,supportsAdoptingStyleSheets:ce,unsafeCSS:zt},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Dt=(s,e,t)=>{const i=new Map;for(let n=e;n<=t;n++)i.set(s[n],n);return i},zr=we(class extends $e{constructor(s){if(super(s),s.type!==I.CHILD)throw Error("repeat() can only be used in text expressions")}dt(s,e,t){let i;t===void 0?t=e:e!==void 0&&(i=e);const n=[],r=[];let o=0;for(const a of s)n[o]=i?i(a,o):o,r[o]=t(a,o),o++;return{values:r,keys:n}}render(s,e,t){return this.dt(s,e,t).values}update(s,[e,t,i]){const n=jr(s),{values:r,keys:o}=this.dt(e,t,i);if(!Array.isArray(n))return this.ut=o,r;const a=this.ut??=[],c=[];let l,p,u=0,b=n.length-1,f=0,v=r.length-1;for(;u<=b&&f<=v;)if(n[u]===null)u++;else if(n[b]===null)b--;else if(a[u]===o[f])c[f]=M(n[u],r[f]),u++,f++;else if(a[b]===o[v])c[v]=M(n[b],r[v]),b--,v--;else if(a[u]===o[v])c[v]=M(n[u],r[v]),F(s,c[v+1],n[u]),u++,v--;else if(a[b]===o[f])c[f]=M(n[b],r[f]),F(s,n[u],n[b]),b--,f++;else if(l===void 0&&(l=Dt(o,f,v),p=Dt(a,u,b)),l.has(a[u]))if(l.has(a[b])){const O=p.get(o[f]),Ee=O!==void 0?n[O]:null;if(Ee===null){const pt=F(s,n[u]);M(pt,r[f]),c[f]=pt}else c[f]=M(Ee,r[f]),F(s,n[u],Ee),n[O]=null;f++}else Ie(n[b]),b--;else Ie(n[u]),u++;for(;f<=v;){const O=F(s,c[v+1]);M(O,r[f]),c[f++]=O}for(;u<=b;){const O=n[u++];O!==null&&Ie(O)}return this.ut=o,ti(s,c),A}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Br=we(class extends $e{constructor(s){if(super(s),s.type!==I.ATTRIBUTE||s.name!=="class"||s.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(s){return" "+Object.keys(s).filter(e=>s[e]).join(" ")+" "}update(s,[e]){if(this.st===void 0){this.st=new Set,s.strings!==void 0&&(this.nt=new Set(s.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in e)e[i]&&!this.nt?.has(i)&&this.st.add(i);return this.render(e)}const t=s.element.classList;for(const i of this.st)i in e||(t.remove(i),this.st.delete(i));for(const i in e){const n=!!e[i];n===this.st.has(i)||this.nt?.has(i)||(n?(t.add(i),this.st.add(i)):(t.remove(i),this.st.delete(i)))}return A}});/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Fr=we(class extends $e{constructor(s){if(super(s),s.type!==I.PROPERTY&&s.type!==I.ATTRIBUTE&&s.type!==I.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Lr(s))throw Error("`live` bindings can only contain a single expression")}render(s){return s}update(s,[e]){if(e===A||e===y)return e;const t=s.element,i=s.name;if(s.type===I.PROPERTY){if(e===t[i])return A}else if(s.type===I.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return A}else if(s.type===I.ATTRIBUTE&&t.getAttribute(i)===e+"")return A;return ti(s),e}});/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class jt extends oe{}jt.directiveName="unsafeSVG",jt.resultType=2;const Po=zr,ko=Br,Mo=Fr,To=qr,Vr=Hr;class Gr extends ${static properties={title:{type:String,reflect:!0},highlight:{type:Boolean,reflect:!0},items:{type:String,reflect:!0},autoincrement:{type:Boolean,reflect:!0}};createRenderRoot(){return this}constructor(){super(),this.data=null,this.allRoles=[]}connectedCallback(){super.connectedCallback(),this._load()}async _load(){this.data=await qn(),this.allRoles=await ve(),this._applyPropsToData(),this.requestUpdate()}_applyPropsToData(){if(this.data&&(this.title&&(this.data.title=this.title),this.highlight!==void 0&&(this.data.highlight=this.highlight),this.items))try{this.data.items=JSON.parse(this.items)}catch(e){console.error("Invalid items JSON:",e)}}render(){const e=x(),t=Hs(),i=Object.values(t).reduce((l,p)=>l+p.length,0),n=j(),r=er(),o=(e?.assignedRoles||[]).map(l=>this.allRoles.find(p=>p.id===l)?.name).filter(l=>l),c={global:"Global Access",organization:"Organization",own:"Own Data Only"}[e?.permissionScope]||e?.permissionScope||"Not Set";return h`
      <div>
        <!-- Welcome Banner -->
    ...
    `}}customElements.define("home-page",Gr);class Jr extends ${static properties={xml:{type:String},error:{type:String},mode:{type:String}};static styles=Bt`
...
`,r+=a}),n.trim()}_escape(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/\"/g,"&quot;").replace(/\'/g,"&#39;")}_highlight(e){let t=e;return t=t.replace(/(&lt;\/?)([\w:-]+)([^&]*?)(&gt;)/g,(i,n,r,o,a)=>{const c=o.replace(/([\w:-]+)(=)(&quot;.*?&quot;)/g,'<span class="attr">$1</span>$2<span class="value">$3</span>');return`<span class="tag">${n}</span><span class="name">${r}</span>${c}<span class="tag">${a}</span>`}).replace(/(^|\n)([^<\n][^\n]*)/g,(i,n,r)=>`${n}<span class="text">${r}</span>`),t}_onSample(){this.xml=`<order id="PO-1001">
  ...
  <items>
    ...
    `}}customElements.define("xml-viewer-page",Jr);class Wr extends ${createRenderRoot(){return this}_goBack(){window.history.back()}_goHome(){window.history.pushState({},"","/"),window.dispatchEvent(new PopStateEvent("popstate"))}render(){return h`
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-6 text-center">
            <div class="py-5">
    ...
    `}}customElements.define("access-denied",Wr);class Yr extends ${static properties={message:{type:String,reflect:!0}};createRenderRoot(){return this}render(){return h`
